...
- **המפתחות שלכם, או בלי מפתחות בכלל.** התחברו עם Genspark ודלגו על הצורך
  ...
  Kimi,‏ GLM,‏ Qwen,‏ Doubao,‏ MiniMax,‏ Grok,‏ Mistral,‏ OpenRouter,‏ API Route,‏ Requesty, או כל
...
OpenRouter,‏ API Route,‏ Requesty ו-OpenCode Zen/Go, ובנוסף שדה מותאם אישית לכל endpoint
...
MiniMax,‏ Grok,‏ Mistral,‏ OpenRouter,‏ API Route,‏ Requesty ו-OpenCode Zen/Go, וכן כל endpoint
