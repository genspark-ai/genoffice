...
- **用你自己的金鑰，或完全不用。** 用 Genspark 登入即可省去金鑰設定，
  ...
  Doubao、MiniMax、Grok、Mistral、OpenRouter、API Route、Requesty，或任何相容 OpenAI 介面
  的服務端點，也支援本機伺服器。
...
Kimi、GLM、Qwen、Doubao、MiniMax、Grok、Mistral、OpenRouter、API Route、Requesty 與
...
MiniMax、Grok、Mistral、OpenRouter、API Route、Requesty 與 OpenCode Zen/Go，以及任何相容
