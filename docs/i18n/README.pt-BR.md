...
- **Suas chaves, ou nenhuma.** Faça login com o Genspark e pule as chaves, ou
  ...
  Qwen, Doubao, MiniMax, Grok, Mistral, OpenRouter, API Route, Requesty, ou qualquer endpoint
...
Doubao, MiniMax, Grok, Mistral, OpenRouter, API Route, Requesty e OpenCode Zen/Go, além de
