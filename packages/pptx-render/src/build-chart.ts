...
function buildChartNodeInner(
  ...
  // Headroom for the top tick label's upper half — only when tick labels actually draw
  const plotY = pad + (legendPos === 't' ? legendH + 4 : 0) + (valLabelsOff ? 0 : labelSizePx * 0.6)
