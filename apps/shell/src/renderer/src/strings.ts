...
export const strings = {
  zh: {
    ...
    setAnalyticsDesc: '通过匿名的功能使用事件帮助改进 GenOffice，绝不收集文档内容或文件名',
    settings: '设置',
    setSecAccount: '账户',
    setSecGeneral: '通用',
    setSecAbout: '关于',
  ...
  en: {
    ...
    setAnalyticsDesc:
      'Help improve GenOffice with anonymous feature-usage events; document contents and file names are never collected',
    settings: 'Settings',
  ...
  ja: {
    ...
    setAnalyticsDesc:
      '匿名の機能使用イベントで GenOffice の改善に協力します。文書の内容やファイル名が収集されることはありません',
    settings: '設定',
    setSecAccount: 'アカウント',
    setSecGeneral: '一般',
    setSecAbout: '情報',
  ...
  ko: {
    ...
    setAnalyticsDesc:
      '익명 기능 사용 이벤트로 GenOffice 개선에 참여합니다. 문서 내용이나 파일 이름은 절대 수집되지 않습니다',
    settings: '설정',
    setSecAccount: '계정',
    setSecGeneral: '일반',
    setSecAbout: '정보',
  ...
  fr: {
    ...
    setAnalyticsDesc:
      "Aidez à améliorer GenOffice grâce à des événements anonymes d'utilisation des fonctionnalités ; le contenu des documents et les noms de fichiers ne sont jamais collectés",
    settings: 'Paramètres',
  ...
  de: {
    ...
    setAnalyticsDesc:
      'Hilf mit anonymen Funktionsnutzungs-Ereignissen, GenOffice zu verbessern; Dokumentinhalte und Dateinamen werden niemals erfasst',
  ...
  es: {
    ...
    setAnalyticsDesc:
      'Ayuda a mejorar GenOffice con eventos anónimos de uso de funciones; nunca se recopilan el contenido de los documentos ni los nombres de archivo',
  ...
  th: {
    ...
    setAnalyticsDesc:
      'ช่วยปรับปรุง GenOffice ด้วยเหตุการณ์การใช้งานฟีเจอร์แบบไม่ระบุตัวตน จะไม่มีการเก็บเนื้อหาเอกสารหรือชื่อไฟล์',
    settings: 'การตั้งค่า',
    setSecAccount: 'บัญชี',
  ...
  id: {
    ...
    setAnalyticsDesc:
      'Bantu menyempurnakan GenOffice dengan peristiwa penggunaan fitur anonim; isi dokumen dan nama file tidak pernah dikumpulkan',
    settings: 'Pengaturan',
    setSecAccount: 'Akun',
    setSecGeneral: 'Umum',
    setSecAbout: 'Tentang',
  ...
  ru: {
    ...
    setAnalyticsDesc:
      'Помогайте улучшать GenOffice с помощью анонимных событий использования функций; содержимое документов и имена файлов никогда не собираются',
    settings: 'Настройки',
  ...
  ar: {
    ...
    setAnalyticsDesc:
      'ساعد في تحسين GenOffice عبر أحداث استخدام الميزات مجهولة الهوية؛ لا يتم أبدًا جمع محتوى المستندات أو أسماء الملفات',
    settings: 'الإعدادات',
  ...
  pt: {
    ...
    setAnalyticsDesc:
      'Ajude a melhorar o GenOffice com eventos anônimos de uso de recursos; o conteúdo dos documentos e os nomes dos arquivos nunca são coletados',
  ...
  it: {
    ...
    setAnalyticsDesc:
      "Aiuta a migliorare GenOffice con eventi anonimi sull'uso delle funzionalità; i contenuti dei documenti e i nomi dei file non vengono mai raccolti",
  ...
  pl: {
    ...
    setAnalyticsDesc:
      'Pomóż ulepszać GenOffice dzięki anonimowym zdarzeniom użycia funkcji; treść dokumentów i nazwy plików nigdy nie są zbierane',
    settings: 'Ustawienia',
    setSecAccount: 'Konto',
  ...
  nl: {
    ...
    setAnalyticsDesc:
      'Help GenOffice te verbeteren met anonieme gebeurtenissen over functiegebruik; documentinhoud en bestandsnamen worden nooit verzameld',
  ...
  ms: {
    ...
    setAnalyticsDesc:
      'Bantu menambah baik GenOffice dengan peristiwa penggunaan ciri tanpa nama; kandungan dokumen dan nama fail tidak sekali-kali dikumpul',
    settings: 'Tetapan',
    setSecAccount: 'Akaun',
    setSecGeneral: 'Umum',
    setSecAbout: 'Perihal',
  ...
  he: {
    ...
    setAnalyticsDesc:
      'עזרו לשפר את GenOffice באמצעות אירועי שימוש אנונימיים בתכונות; תוכן המסמכים ושמות הקבצים לעולם אינם נאספים',
    settings: 'הגדרות',
    setSecAccount: 'חשבון',
    setSecGeneral: 'כללי',
    setSecAbout: 'אודות',
  ...
  hi: {
    ...
    setAnalyticsDesc:
      'गुमनाम फ़ीचर-उपयोग इवेंट से GenOffice को बेहतर बनाने में मदद करें; दस्तावेज़ की सामग्री और फ़ाइल नाम कभी एकत्र नहीं किए जाते',
    settings: 'सेटिंग्स',
    setSecAccount: 'खाता',
  ...
  'zh-TW': {
    ...
    setAnalyticsDesc: '透過匿名的功能使用事件協助改進 GenOffice，絕不收集文件內容或檔案名稱',
    settings: '設定',
    setSecAccount: '帳戶',
    setSecGeneral: '一般',
    setSecAbout: '關於',
