...
export const strings = {
  zh: {
    ...
    aiSettingsGensparkHint: '登录 Genspark 账户后可用,无需填写密钥。',
    aiSettingsOpenCodeHint: '本地 opencode 服务,无需 API 密钥。',
    aiSettingsModelPlaceholder: '留空使用服务端默认模型',
    aiSettingsCustomModelPlaceholder: '自定义模型 ID(可选)',
    aiSettingsSave: '保存',
    // Dates
    today: '今天',
    yesterday: '昨天',
  ...
  en: {
    ...
    aiSettingsBaseUrl: 'Base URL',
    aiSettingsGensparkHint: 'Available after signing in to your Genspark account — no key needed.',
    aiSettingsOpenCodeHint: 'Local opencode server — no API key required.',
    aiSettingsModelPlaceholder: 'Empty = server default model',
    aiSettingsCustomModelPlaceholder: 'Custom model ID (optional)',
    aiSettingsSave: 'Save',
    today: 'Today',
    yesterday: 'Yesterday',
    daysAgo: '{n}d ago',
  ...
  ja: {
    ...
    aiSettingsBaseUrl: 'Base URL',
    aiSettingsGensparkHint: 'Genspark アカウントにサインインすると利用できます。キーは不要です。',
    aiSettingsOpenCodeHint: 'ローカルの opencode サーバー — API キーは不要です。',
    aiSettingsModelPlaceholder: '空欄 = サーバー既定モデル',
    aiSettingsCustomModelPlaceholder: 'カスタムモデル ID(任意)',
    aiSettingsSave: '保存',
    // Dates
    today: '今日',
    yesterday: '昨日',
  ...
  ko: {
    ...
    aiSettingsBaseUrl: 'Base URL',
    aiSettingsGensparkHint: 'Genspark 계정에 로그인하면 사용할 수 있습니다. 키가 필요 없습니다.',
    aiSettingsOpenCodeHint: '로컬 opencode 서버 — API 키가 필요 없습니다.',
    aiSettingsModelPlaceholder: '비우면 서버 기본 모델',
    aiSettingsCustomModelPlaceholder: '사용자 지정 모델 ID(선택)',
    aiSettingsSave: '저장',
    // Dates
    today: '오늘',
    yesterday: '어제',
  ...
  fr: {
    ...
    aiSettingsGensparkHint: 'Disponible après connexion à votre compte Genspark — aucune clé requise.',
    aiSettingsOpenCodeHint: 'Serveur opencode local — aucune clé API requise.',
    aiSettingsModelPlaceholder: 'Vide = modèle par défaut du serveur',
    aiSettingsCustomModelPlaceholder: 'ID de modèle personnalisé (facultatif)',
  ...
  de: {
    ...
    aiSettingsGensparkHint: 'Nach Anmeldung bei Ihrem Genspark-Konto verfügbar — kein Schlüssel nötig.',
    aiSettingsOpenCodeHint: 'Lokaler opencode-Server — kein API-Schlüssel erforderlich.',
    aiSettingsModelPlaceholder: 'Leer = Standardmodell des Servers',
    aiSettingsCustomModelPlaceholder: 'Benutzerdefinierte Modell-ID (optional)',
  ...
  es: {
    ...
    aiSettingsGensparkHint: 'Disponible tras iniciar sesión en su cuenta de Genspark — no se necesita clave.',
    aiSettingsOpenCodeHint: 'Servidor opencode local — no se requiere clave API.',
    aiSettingsModelPlaceholder: 'Vacío = modelo predeterminado del servidor',
    aiSettingsCustomModelPlaceholder: 'ID de modelo personalizado (opcional)',
  ...
  th: {
    ...
    aiSettingsGensparkHint: 'ใช้งานได้หลังเข้าสู่ระบบบัญชี Genspark — ไม่ต้องใช้คีย์',
    aiSettingsOpenCodeHint: 'เซิร์ฟเวอร์ opencode ในเครื่อง — ไม่ต้องใช้คีย์ API',
    aiSettingsModelPlaceholder: 'ว่าง = โมเดลเริ่มต้นของเซิร์ฟเวอร์',
    aiSettingsCustomModelPlaceholder: 'รหัสโมเดลที่กำหนดเอง (ไม่บังคับ)',
  ...
  id: {
    ...
    aiSettingsGensparkHint: 'Tersedia setelah masuk ke akun Genspark — tidak perlu kunci.',
    aiSettingsOpenCodeHint: 'Server opencode lokal — tidak perlu kunci API.',
    aiSettingsModelPlaceholder: 'Kosong = model bawaan server',
    aiSettingsCustomModelPlaceholder: 'ID model kustom (opsional)',
  ...
  ru: {
    ...
    aiSettingsProvider: 'Поставщик ИИ',
    aiSettingsModel: 'Модель',
    aiSettingsApiKey: 'API-ключ',
    aiSettingsBaseUrl: 'Базовый URL',
    aiSettingsGensparkHint: 'Доступно после входа в аккаунт Genspark — ключ не нужен.',
    aiSettingsOpenCodeHint: 'Локальный сервер opencode — API-ключ не требуется.',
    aiSettingsModelPlaceholder: 'Пусто = модель сервера по умолчанию',
    aiSettingsCustomModelPlaceholder: 'Пользовательский ID модели (необязательно)',
  ...
  ar: {
    ...
    aiSettingsGensparkHint: 'متاح بعد تسجيل الدخول إلى حساب Genspark — لا حاجة لمفتاح.',
    aiSettingsOpenCodeHint: 'خادم opencode محلي — لا حاجة لمفتاح API.',
    aiSettingsModelPlaceholder: 'فارغ = النموذج الافتراضي للخادم',
    aiSettingsCustomModelPlaceholder: 'معرف نموذج مخصص (اختياري)',
    aiSettingsSave: 'حفظ',
    // Dates
    today: 'اليوم',
    yesterday: 'أمس',
  ...
  pt: {
    ...
    aiSettingsBaseUrl: 'URL base',
    aiSettingsGensparkHint: 'Disponível após entrar na sua conta Genspark — nenhuma chave necessária.',
    aiSettingsOpenCodeHint: 'Servidor opencode local — nenhuma chave de API necessária.',
    aiSettingsModelPlaceholder: 'Vazio = modelo padrão do servidor',
    aiSettingsCustomModelPlaceholder: 'ID de modelo personalizado (opcional)',
  ...
  it: {
    ...
    aiSettingsProvider: 'Fornitore IA',
    aiSettingsModel: 'Modello',
    aiSettingsApiKey: 'Chiave API',
    aiSettingsBaseUrl: 'URL di base',
    aiSettingsGensparkHint: "Disponibile dopo l'accesso al tuo account Genspark — nessuna chiave richiesta.",
    aiSettingsOpenCodeHint: 'Server opencode locale — nessuna chiave API richiesta.',
    aiSettingsModelPlaceholder: 'Vuoto = modello predefinito del server',
    aiSettingsCustomModelPlaceholder: 'ID modello personalizzato (facoltativo)',
  ...
  pl: {
    ...
    aiSettingsBaseUrl: 'Adres URL',
    aiSettingsGensparkHint: 'Dostępne po zalogowaniu na konto Genspark — klucz nie jest wymagany.',
    aiSettingsOpenCodeHint: 'Lokalny serwer opencode — klucz API nie jest wymagany.',
    aiSettingsModelPlaceholder: 'Puste = domyślny model serwera',
    aiSettingsCustomModelPlaceholder: 'Niestandardowy ID modelu (opcjonalnie)',
  ...
  nl: {
    ...
    aiSettingsBaseUrl: 'Basis-URL',
    aiSettingsGensparkHint: 'Beschikbaar na aanmelding bij uw Genspark-account — geen sleutel nodig.',
    aiSettingsOpenCodeHint: 'Lokale opencode-server — geen API-sleutel vereist.',
    aiSettingsModelPlaceholder: 'Leeg = standaardmodel van server',
    aiSettingsCustomModelPlaceholder: 'Aangepaste model-ID (optioneel)',
  ...
  ms: {
    ...
    aiSettingsGensparkHint: 'Tersedia selepas log masuk ke akaun Genspark — tiada kunci diperlukan.',
    aiSettingsOpenCodeHint: 'Pelayan opencode setempat — tiada kunci API diperlukan.',
    aiSettingsModelPlaceholder: 'Kosong = model lalai pelayan',
    aiSettingsCustomModelPlaceholder: 'ID model tersuai (pilihan)',
    aiSettingsSave: 'Simpan',
    today: 'Hari ini',
    yesterday: 'Semalam',
    daysAgo: '{n} hari lalu',
  ...
  he: {
    ...
    aiSettingsProvider: 'ספק AI',
    aiSettingsModel: 'מודל',
    aiSettingsApiKey: 'מפתח API',
    aiSettingsBaseUrl: 'כתובת URL בסיסית',
    aiSettingsGensparkHint: 'זמין לאחר התחברות לחשבון Genspark — אין צורך במפתח.',
    aiSettingsOpenCodeHint: 'שרת opencode מקומי — אין צורך במפתח API.',
    aiSettingsModelPlaceholder: 'ריק = מודל ברירת המחדל של השרת',
    aiSettingsCustomModelPlaceholder: 'מזהה מודל מותאם אישית (אופציונלי)',
    aiSettingsSave: 'שמור',
    today: 'היום',
    yesterday: 'אתמול',
    daysAgo: 'לפני {n} ימים',
  ...
  hi: {
    ...
    aiSettingsGensparkHint: 'Genspark खाते में साइन इन करने के बाद उपलब्ध — कुंजी की आवश्यकता नहीं।',
    aiSettingsOpenCodeHint: 'लोकल opencode सर्वर — API कुंजी की आवश्यकता नहीं।',
    aiSettingsModelPlaceholder: 'खाली = सर्वर डिफ़ॉल्ट मॉडल',
    aiSettingsCustomModelPlaceholder: 'कस्टम मॉडल ID (वैकल्पिक)',
  ...
  'zh-TW': {
    ...
    aiSettingsBaseUrl: 'Base URL',
    aiSettingsGensparkHint: '登入 Genspark 帳戶後即可使用,無需金鑰。',
    aiSettingsOpenCodeHint: '本機 opencode 服務,無需 API 金鑰。',
    aiSettingsModelPlaceholder: '留空使用伺服器預設模型',
    aiSettingsCustomModelPlaceholder: '自訂模型 ID(選填)',
    aiSettingsSave: '儲存',
    today: '今天',
    yesterday: '昨天',
    daysAgo: '{n} 天前',
