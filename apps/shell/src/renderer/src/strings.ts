...
const aiSettingsZh = {
  ...
  aiTextModelsTab: '文本模型',
  aiTextModelsTabHint: '聊天、写作和编辑',
  aiImageModelsTab: '图像模型',
  aiImageModelsTabHint: '生成演示文稿图像',
  aiImageProviderTitle: '图像生成',
  aiImageProviderDescription: '为演示文稿和其他图像功能选择默认提供商。',
  aiImageProviderLabel: '图像提供商',
  aiProviderListLabel: '提供商',
  aiSearchProviders: '搜索提供商',
  aiProviderConfigured: '已配置凭据',
  aiProviderActive: '正在使用',
  aiProviderLocal: '本地',
  aiProviderOpenAiCompatible: 'OpenAI 兼容',
  aiProviderCloud: '云端',
  aiModelLabel: '模型',
  aiModelsAvailable: '共 {count} 个',
  aiModelPlaceholder: '输入模型 ID',
  aiCustomModelOption: '自定义模型…',
  aiCustomModelLabel: '自定义模型 ID',
  aiCustomModelPlaceholder: '输入提供商使用的准确模型 ID',
  aiCustomModelHint: '使用提供商文档中显示的准确模型名称或 ID。',
  aiNoModelSelected: '未选择模型',
  aiModelDiscoveryHint: '保存密钥后会自动加载模型，也可手动刷新。',
  aiRunwareDiscoveryHint: 'Runware 模型目录较大，仅在点击刷新时加载；自定义模型测试不会刷新目录。',
  aiRefreshModels: '刷新模型',
  aiLoadingModels: '正在加载模型…',
  aiTestingModel: '正在检查所选模型…',
  aiCuratedModelsHint: '此列表包含该提供商支持的图像或文本模型。',
  aiEndpointLabel: '端点 URL',
  aiEndpointHint: '使用提供商的 OpenAI 兼容 API 根地址。',
  aiApiKeyLabel: 'API 密钥',
  aiApiKeyPlaceholder: '输入 API 密钥',
  aiApiKeySavedPlaceholder: '已保存密钥；留空以保留',
  aiApiKeyHint: '密钥不会从设置页面读回。',
  aiApiKeySaved: '已保存的密钥：',
  aiRemoveKey: '移除',
  aiCredentialRemoved: '已移除 API 密钥。',
  aiLocalProviderHint: '此提供商在本机运行，不需要 API 密钥。请确保其服务已启动。',
  aiCurrentSelection: '当前选择',
  aiTestConnection: '测试连接',
  aiTesting: '测试中…',
  aiCancelTest: '取消',
  aiCancelTestFailed: '无法取消模型检查。',
  aiSaveProvider: '保存提供商',
  aiSaving: '保存中…',
  aiSettingsSaved: '提供商设置已保存。',
  aiSettingsSaveFailed: '无法保存提供商设置。',
  aiSettingsTestFailed: '无法测试提供商连接。',
  aiSettingsLoadFailed: '无法读取提供商设置。',
} as const
...
const aiSettingsEn = {
  ...
  aiProviderModeLabel: 'AI model type',
  aiTextModelsTab: 'Text models',
  aiTextModelsTabHint: 'Chat, writing, and editing',
  aiImageModelsTab: 'Image models',
  aiImageModelsTabHint: 'Generate presentation artwork',
  aiImageProviderTitle: 'Image generation',
  aiImageProviderDescription:
    'Choose the default provider for presentations and other image features.',
  aiImageProviderLabel: 'Image provider',
  aiProviderListLabel: 'Providers',
  aiSearchProviders: 'Search providers',
  aiProviderConfigured: 'Credential configured',
  aiProviderActive: 'In use',
  aiProviderLocal: 'Local',
  aiProviderOpenAiCompatible: 'OpenAI-compatible',
  aiProviderCloud: 'Cloud',
  aiModelLabel: 'Model',
  aiModelsAvailable: '{count} available',
  aiModelPlaceholder: 'Enter a model ID',
  aiCustomModelOption: 'Custom model…',
  aiCustomModelLabel: 'Custom model ID',
  aiCustomModelPlaceholder: 'Enter the exact provider model ID',
  aiCustomModelHint: 'Use the exact model name or ID shown in the provider documentation.',
  aiNoModelSelected: 'No model selected',
  aiModelDiscoveryHint: 'Models load when a saved key is available. You can also refresh them.',
  aiRunwareDiscoveryHint:
    'Runware’s large catalog loads only when you click Refresh models. Custom model tests do not refresh it.',
  aiRefreshModels: 'Refresh models',
  aiLoadingModels: 'Loading models…',
  aiTestingModel: 'Checking the selected model…',
  aiCuratedModelsHint: 'This list contains the supported models for this provider.',
  aiEndpointLabel: 'Endpoint URL',
  aiEndpointHint: 'Use the provider’s OpenAI-compatible API root URL.',
  aiApiKeyLabel: 'API key',
  aiApiKeyPlaceholder: 'Enter an API key',
  aiApiKeySavedPlaceholder: 'Key saved; leave blank to keep it',
  aiApiKeyHint: 'Keys are never read back into the settings page.',
  aiApiKeySaved: 'Saved key:',
  aiRemoveKey: 'Remove',
  aiCredentialRemoved: 'API key removed.',
  aiLocalProviderHint:
    'This provider runs on your computer and needs no API key. Make sure its service is running.',
  aiCurrentSelection: 'Current selection',
  aiTestConnection: 'Test connection',
  aiTesting: 'Testing…',
  aiCancelTest: 'Cancel',
  aiCancelTestFailed: 'Could not cancel the model check.',
  aiSaveProvider: 'Save provider',
  aiSaving: 'Saving…',
  aiSettingsSaved: 'Provider settings saved.',
  aiSettingsSaveFailed: 'Could not save provider settings.',
  aiSettingsTestFailed: 'Could not test the provider connection.',
...
export const strings = {
  zh: { ...baseStrings.zh, ...aiSettingsTables.zh },
  en: { ...baseStrings.en, ...aiSettingsTables.en },
  ja: { ...baseStrings.ja, ...aiSettingsTables.ja },
  ko: { ...baseStrings.ko, ...aiSettingsTables.ko },
  fr: { ...baseStrings.fr, ...aiSettingsTables.fr },
  de: { ...baseStrings.de, ...aiSettingsTables.de },
  es: { ...baseStrings.es, ...aiSettingsTables.es },
  th: { ...baseStrings.th, ...aiSettingsTables.th },
  id: { ...baseStrings.id, ...aiSettingsTables.id },
  ru: { ...baseStrings.ru, ...aiSettingsTables.ru },
  ar: { ...baseStrings.ar, ...aiSettingsTables.ar },
  pt: { ...baseStrings.pt, ...aiSettingsTables.pt },
  it: { ...baseStrings.it, ...aiSettingsTables.it },
  pl: { ...baseStrings.pl, ...aiSettingsTables.pl },
  nl: { ...baseStrings.nl, ...aiSettingsTables.nl },
  ms: { ...baseStrings.ms, ...aiSettingsTables.ms },
  he: { ...baseStrings.he, ...aiSettingsTables.he },
  hi: { ...baseStrings.hi, ...aiSettingsTables.hi },
  'zh-TW': { ...baseStrings['zh-TW'], ...aiSettingsTables['zh-TW'] },
} as const
