...
export const strings = {
  zh: {
    ...
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'KARYA Projects',
    cloudSubtitle: '在网页端用 KARYA AI 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录 KARYA 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    noContent: '（无内容）',
    // Account
    accountGenspark: 'KARYA 账号',
    account: '账号',
    login: '登录',
    loginGenspark: '登录 KARYA 账号',
    loggedIn: '已登录',
    loggedInGenspark: '已登录 KARYA',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 KARYA,请检查网络或代理设置',
    ...
    starPromptTitle: '喜欢 KĀRYA 吗？',
    starPromptTitleN: '你已经用 KĀRYA 打开了 {n} 个文档',
    starPromptBody: 'KĀRYA 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 KĀRYA，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    aboutAttribution: "KĀRYA 派生自并修改自 GenOffice——一个由 Mainfunc, Inc.（KARYA）开发的开放源代码 AI 原生办公套件。本产品与 KARYA 无隶属或背书关系。",
    aboutLicense: "依据 Apache License 2.0 许可。",
    aboutClose: "关闭",
    tabList: '全部标签',
    newTab: '新建标签页',
    // First-run onboarding
    onbTitle1: '欢迎使用 KĀRYA',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'KĀRYA 目前处于 alpha 阶段。欢迎加入 GenTeam 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '1,000+ KARYA 积分**',
  ...
  en: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'Projects created on the web with KARYA AI. Editing continues in your browser — click any project to open it.',
    ...
    cloudLoginHint: 'Sign in to your KARYA account to see projects you created on the web.',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountGenspark: 'KARYA Account',
    account: 'Account',
    login: 'Sign in',
    loginGenspark: 'Sign in with KARYA',
    loggedIn: 'Signed in',
    loggedInGenspark: 'Signed in to KARYA',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach KARYA — check your network or proxy settings',
    ...
    starPromptTitle: 'Enjoying KĀRYA?',
    starPromptTitleN: "You've opened {n} documents with KĀRYA",
    starPromptBody:
      'KĀRYA is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like KĀRYA, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    aboutAttribution: "KĀRYA is derived from and modified from GenOffice, an open-source AI-native office suite originally developed by Mainfunc, Inc. (KARYA). This product is not affiliated with or endorsed by KARYA.",
    aboutLicense: "Licensed under the Apache License, Version 2.0.",
    aboutClose: "Close",
    tabList: 'All tabs',
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to KĀRYA',
    ...
    onbBody2:
      'KĀRYA is still in alpha. Join the group chat on GenTeam to share feedback and help shape what comes next.',
    onbCredits: '1,000+ KARYA credits**',
  ...
  ja: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'Web で KARYA AI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      'KARYA アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    noContent: '（内容なし）',
    // Account
    accountGenspark: 'KARYA アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginGenspark: 'KARYA アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInGenspark: 'KARYA にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      'KARYA に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    starPromptTitle: 'KĀRYA はいかがですか？',
    starPromptTitleN: 'KĀRYA で {n} 件のドキュメントを開きました',
    starPromptBody:
      'KĀRYA は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'KĀRYA が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
    ...
    aboutAttribution: "KĀRYA は、Mainfunc, Inc.（KARYA）が開発したオープンソースの AI ネイティブオフィススイート GenOffice を元にしたフォークです。本製品は KARYA とは提携・承認関係にありません。",
    aboutLicense: "Apache License 2.0 に基づいてライセンスされています。",
    aboutClose: "閉じる",
    tabList: 'すべてのタブ',
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'KĀRYA へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'KĀRYA はまだアルファ版です。GenTeam のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: '1,000+ KARYA クレジット**',
    ...
    onbNote3: '.*KARYA クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'KARYA AI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: 'KARYA 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    noContent: '(내용 없음)',
    // Account
    accountGenspark: 'KARYA 계정',
    account: '계정',
    login: '로그인',
    loginGenspark: 'KARYA 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInGenspark: 'KARYA에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'KARYA에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    starPromptTitle: 'KĀRYA가 마음에 드시나요?',
    starPromptTitleN: 'KĀRYA로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'KĀRYA는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'KĀRYA가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
    ...
    aboutAttribution: "KĀRYA는 Mainfunc, Inc.(KARYA)가 개발한 오픈소스 AI 네이티브 오피스 제품군 GenOffice에서 파생·수정되었습니다. 본 제품은 KARYA와 제휴 또는 보증 관계가 없습니다.",
    aboutLicense: "Apache License 2.0에 따라 사용이 허가됩니다.",
    aboutClose: "닫기",
    tabList: '모든 탭',
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'KĀRYA에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'KĀRYA는 아직 알파 단계입니다. GenTeam 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '1,000+ KARYA 크레딧**',
    ...
    onbNote3: '.*KARYA 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      "Projets créés sur le web avec KARYA AI. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    cloudLoginHint:
      'Connectez-vous à votre compte KARYA pour voir les projets créés sur le web.',
    ...
    noContent: '(vide)',
    // Account
    accountGenspark: 'Compte KARYA',
    account: 'Compte',
    login: 'Se connecter',
    loginGenspark: 'Se connecter avec KARYA',
    loggedIn: 'Connecté',
    loggedInGenspark: 'Connecté à KARYA',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre KARYA — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    starPromptTitle: 'KĀRYA vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec KĀRYA',
    starPromptBody:
      'KĀRYA est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si KĀRYA vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    aboutAttribution: "KĀRYA est dérivé et modifié de GenOffice, une suite bureautique open source native IA développée à l'origine par Mainfunc, Inc. (KARYA). Ce produit n'est ni affilié à KARYA ni approuvé par KARYA.",
    aboutLicense: "Sous licence Apache License 2.0.",
    aboutClose: "Fermer",
    tabList: 'Tous les onglets',
    newTab: 'Nouvel onglet',
    // First-run onboarding
    onbTitle1: 'Bienvenue dans KĀRYA',
    ...
    onbBody2:
      'KĀRYA est encore en alpha. Rejoignez la discussion de groupe sur GenTeam pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits KARYA**',
  ...
  de: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'Mit KARYA AI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem KARYA-Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    noContent: '(leer)',
    // Account
    accountGenspark: 'KARYA-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginGenspark: 'Mit KARYA anmelden',
    loggedIn: 'Angemeldet',
    loggedInGenspark: 'Bei KARYA angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'KARYA ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    starPromptTitle: 'Gefällt Ihnen KĀRYA?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit KĀRYA geöffnet',
    starPromptBody:
      'KĀRYA ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen KĀRYA gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    aboutAttribution: "KĀRYA ist eine Abwandlung von GenOffice, einer Open-Source-Office-Suite mit KI-Fokus, die ursprünglich von Mainfunc, Inc. (KARYA) entwickelt wurde. Dieses Produkt ist weder mit KARYA verbunden noch von KARYA unterstützt.",
    aboutLicense: "Lizenziert unter der Apache License 2.0.",
    aboutClose: "Schließen",
    tabList: 'Alle Tabs',
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei KĀRYA',
    ...
    onbBody2:
      'KĀRYA ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ KARYA-Guthaben**',
    ...
    onbNote3: '.*KARYA-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'Proyectos creados en la web con KARYA AI. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    cloudLoginHint:
      'Inicia sesión en tu cuenta de KARYA para ver los proyectos creados en la web.',
    ...
    noContent: '(vacío)',
    // Account
    accountGenspark: 'Cuenta de KARYA',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginGenspark: 'Iniciar sesión con KARYA',
    loggedIn: 'Sesión iniciada',
    loggedInGenspark: 'Sesión iniciada en KARYA',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con KARYA — compruebe su red o la configuración del proxy',
    ...
    starPromptTitle: '¿Te gusta KĀRYA?',
    starPromptTitleN: 'Has abierto {n} documentos con KĀRYA',
    starPromptBody:
      'KĀRYA es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta KĀRYA, danos una estrella en GitHub.',
    ...
    aboutAttribution: "KĀRYA se deriva de GenOffice y se basa en él, una suite ofimática de código abierto con IA desarrollada originalmente por Mainfunc, Inc. (KARYA). Este producto no está afiliado ni respaldado por KARYA.",
    aboutLicense: "Con licencia Apache License 2.0.",
    aboutClose: "Cerrar",
    tabList: 'Todas las pestañas',
    newTab: 'Nueva pestaña',
    // First-run onboarding
    onbTitle1: 'Bienvenido a KĀRYA',
    ...
    onbBody2:
      'KĀRYA aún está en alfa. Únete al chat grupal en GenTeam para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de KARYA**',
  ...
  th: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย KARYA AI แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี KARYA เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    // Account
    accountGenspark: 'บัญชี KARYA',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginGenspark: 'ลงชื่อเข้าใช้ด้วย KARYA',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInGenspark: 'ลงชื่อเข้าใช้ KARYA แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ KARYA ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    starPromptTitle: 'ชอบ KĀRYA ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย KĀRYA ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'KĀRYA ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ KĀRYA ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    aboutAttribution: "KĀRYA พัฒนาต่อยอดและปรับปรุงจาก GenOffice ชุดโปรแกรมสำนักงานโอเพนซอร์สที่เน้น AI ซึ่งพัฒนาโดย Mainfunc, Inc. (KARYA) ผลิตภัณฑ์นี้ไม่มีความเกี่ยวข้องหรือได้รับการรับรองจาก KARYA",
    aboutLicense: "อยู่ภายใต้สัญญาอนุญาต Apache License 2.0",
    aboutClose: "ปิด",
    tabList: 'แท็บทั้งหมด',
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ KĀRYA',
    ...
    onbBody2:
      'KĀRYA ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต KARYA กว่า 1,000**',
  ...
  id: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan KARYA AI. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun KARYA untuk melihat proyek yang Anda buat di web.',
    ...
    noContent: '(kosong)',
    // Account
    accountGenspark: 'Akun KARYA',
    account: 'Akun',
    login: 'Masuk',
    loginGenspark: 'Masuk dengan KARYA',
    loggedIn: 'Sudah masuk',
    loggedInGenspark: 'Sudah masuk ke KARYA',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke KARYA — periksa jaringan atau pengaturan proxy Anda',
    ...
    starPromptTitle: 'Suka KĀRYA?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan KĀRYA',
    starPromptBody:
      'KĀRYA gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai KĀRYA, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    aboutAttribution: "KĀRYA diturunkan dan dimodifikasi dari GenOffice, paket aplikasi perkantoran sumber terbuka berbasis AI yang awalnya dikembangkan oleh Mainfunc, Inc. (KARYA). Produk ini tidak berafiliasi dengan atau didukung oleh KARYA.",
    aboutLicense: "Dilisensikan di bawah Apache License 2.0.",
    aboutClose: "Tutup",
    tabList: 'Semua tab',
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di KĀRYA',
    ...
    onbBody2:
      'KĀRYA masih dalam tahap alpha. Gabung obrolan grup di GenTeam untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit KARYA**',
  ...
  ru: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с KARYA AI. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в аккаунт KARYA, чтобы увидеть проекты, созданные в вебе.',
    ...
    noContent: '(пусто)',
    // Account
    accountGenspark: 'Учётная запись KARYA',
    account: 'Учётная запись',
    login: 'Войти',
    loginGenspark: 'Войти через KARYA',
    loggedIn: 'Вход выполнен',
    loggedInGenspark: 'Выполнен вход в KARYA',
    ...
    loginNetworkError: 'Не удаётся подключиться к KARYA — проверьте сеть или настройки прокси',
    ...
    starPromptTitle: 'Нравится KĀRYA?',
    starPromptTitleN: 'Вы уже открыли {n} документов в KĀRYA',
    starPromptBody:
      'KĀRYA — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится KĀRYA, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    aboutAttribution: "KĀRYA является производным от GenOffice — офисного пакета с открытым исходным кодом и встроенным ИИ, разработанного Mainfunc, Inc. (KARYA). Этот продукт не связан с KARYA и не одобрен им.",
    aboutLicense: "Распространяется по лицензии Apache License 2.0.",
    aboutClose: "Закрыть",
    tabList: 'Все вкладки',
    newTab: 'Новая вкладка',
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в KĀRYA',
    ...
    onbBody2:
      'KĀRYA пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов KARYA**',
  ...
  ar: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام KARYA AI. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب KARYA لعرض المشاريع التي أنشأتها على الويب.',
    ...
    noContent: '(فارغ)',
    // Account
    accountGenspark: 'حساب KARYA',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginGenspark: 'تسجيل الدخول باستخدام KARYA',
    loggedIn: 'تم تسجيل الدخول',
    loggedInGenspark: 'تم تسجيل الدخول إلى KARYA',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ KARYA — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    starPromptTitle: 'هل أعجبك KĀRYA؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في KĀRYA',
    starPromptBody: 'KĀRYA مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك KĀRYA، ضع لنا نجمة على GitHub.',
    ...
    aboutAttribution: "KĀRYA مشتق من GenOffice، حزمة المكاتب مفتوحة المصدر القائمة على الذكاء الاصطناعي التي طورتها Mainfunc, Inc. (KARYA). هذا المنتج غير تابع لـ KARYA ولا يحظى بتأييدها.",
    aboutLicense: "مرخّص بموجب رخصة Apache License 2.0.",
    aboutClose: "إغلاق",
    tabList: 'كل علامات التبويب',
    newTab: 'علامة تبويب جديدة',
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في KĀRYA',
    ...
    onbBody2:
      'لا يزال KĀRYA في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة KARYA**',
  ...
  pt: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'Projetos criados na web com o KARYA AI. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta KARYA para ver os projetos criados na web.',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountGenspark: 'Conta KARYA',
    account: 'Conta',
    login: 'Entrar',
    loginGenspark: 'Entrar com a KARYA',
    loggedIn: 'Conectado',
    loggedInGenspark: 'Conectado à KARYA',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao KARYA — verifique sua rede ou as configurações de proxy',
    ...
    starPromptTitle: 'Gostando do KĀRYA?',
    starPromptTitleN: 'Você já abriu {n} documentos com o KĀRYA',
    starPromptBody:
      'O KĀRYA é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do KĀRYA, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    aboutAttribution: "O KĀRYA é derivado e modificado do GenOffice, um pacote de escritório de código aberto com IA desenvolvido originalmente pela Mainfunc, Inc. (KARYA). Este produto não é afiliado nem endossado pela KARYA.",
    aboutLicense: "Licenciado sob a Apache License 2.0.",
    aboutClose: "Fechar",
    tabList: 'Todas as guias',
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao KĀRYA',
    ...
    onbBody2:
      'O KĀRYA ainda está em alfa. Entre no chat em grupo no GenTeam para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos KARYA**',
  ...
  it: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'Progetti creati sul web con KARYA AI. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account KARYA per vedere i progetti creati sul web.',
    ...
    noContent: '(vuoto)',
    accountGenspark: 'Account KARYA',
    account: 'Account',
    login: 'Accedi',
    loginGenspark: 'Accedi con KARYA',
    loggedIn: 'Accesso effettuato',
    loggedInGenspark: 'Accesso effettuato a KARYA',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere KARYA — controlla la rete o le impostazioni del proxy',
    ...
    starPromptTitle: 'Ti piace KĀRYA?',
    starPromptTitleN: 'Hai aperto {n} documenti con KĀRYA',
    starPromptBody:
      'KĀRYA è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace KĀRYA, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    aboutAttribution: "KĀRYA è derivato e modificato da GenOffice, una suite per ufficio open source con IA originariamente sviluppata da Mainfunc, Inc. (KARYA). Questo prodotto non è affiliato né approvato da KARYA.",
    aboutLicense: "Concesso in licenza con Apache License 2.0.",
    aboutClose: "Chiudi",
    tabList: 'Tutte le schede',
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in KĀRYA',
    ...
    onbBody2:
      'KĀRYA è ancora in alpha. Unisciti alla chat di gruppo su GenTeam per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti KARYA**',
  ...
  pl: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą KARYA AI. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto KARYA, aby zobaczyć projekty utworzone w sieci.',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountGenspark: 'Konto KARYA',
    account: 'Konto',
    login: 'Zaloguj się',
    loginGenspark: 'Zaloguj się przez KARYA',
    loggedIn: 'Zalogowano',
    loggedInGenspark: 'Zalogowano do KARYA',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z KARYA — sprawdź sieć lub ustawienia proxy',
    ...
    starPromptTitle: 'Podoba Ci się KĀRYA?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w KĀRYA',
    starPromptBody:
      'KĀRYA jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się KĀRYA, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    aboutAttribution: "KĀRYA pochodzi z GenOffice i jest jego modyfikacją — pakietu biurowego o otwartym kodzie źródłowym z wbudowaną AI, opracowanego pierwotnie przez Mainfunc, Inc. (KARYA). Ten produkt nie jest powiązany z KARYA ani przez niego zatwierdzony.",
    aboutLicense: "Licencjonowane na Apache License 2.0.",
    aboutClose: "Zamknij",
    tabList: 'Wszystkie karty',
    newTab: 'Nowa karta',
    // First-run onboarding
    onbTitle1: 'Witamy w KĀRYA',
    ...
    onbBody2:
      'KĀRYA jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów KARYA**',
  ...
  nl: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met KARYA AI. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    cloudLoginHint:
      'Log in op je KARYA-account om projecten te zien die je op het web hebt gemaakt.',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginGenspark: 'Inloggen met KARYA',
    loggedIn: 'Ingelogd',
    loggedInGenspark: 'Ingelogd bij KARYA',
    ...
    loginNetworkError: 'Kan KARYA niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    starPromptTitle: 'Bevalt KĀRYA?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met KĀRYA',
    starPromptBody:
      'KĀRYA is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als KĀRYA je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    aboutAttribution: "KĀRYA is afgeleid van en aangepast op basis van GenOffice, een opensource-kantoorpakket met AI dat oorspronkelijk is ontwikkeld door Mainfunc, Inc. (KARYA). Dit product is niet verbonden aan of goedgekeurd door KARYA.",
    aboutLicense: "Gelicenseerd onder de Apache License 2.0.",
    aboutClose: "Sluiten",
    tabList: 'Alle tabbladen',
    newTab: 'Nieuw tabblad',
    // First-run onboarding
    onbTitle1: 'Welkom bij KĀRYA',
    ...
    onbBody2:
      'KĀRYA is nog in alfa. Doe mee aan de groepschat op GenTeam om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ KARYA-credits**',
    ...
    onbNote3: '.*KARYA-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan KARYA AI. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun KARYA untuk melihat projek yang anda cipta di web.',
    ...
    noContent: '(kosong)',
    accountGenspark: 'Akaun KARYA',
    account: 'Akaun',
    login: 'Log masuk',
    loginGenspark: 'Log masuk dengan KARYA',
    loggedIn: 'Telah log masuk',
    loggedInGenspark: 'Telah log masuk ke KARYA',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke KARYA — semak rangkaian atau tetapan proksi anda',
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan KĀRYA',
    starPromptBody:
      'KĀRYA percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka KĀRYA, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    aboutAttribution: "KĀRYA diterbitkan dan diubah suai daripada GenOffice, suite pejabat sumber terbuka berasaskan AI yang dibangunkan oleh Mainfunc, Inc. (KARYA). Produk ini tidak bergabung dengan atau disokong oleh KARYA.",
    aboutLicense: "Dilesenkan di bawah Apache License 2.0.",
    aboutClose: "Tutup",
    tabList: 'Semua tab',
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke KĀRYA',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'KĀRYA masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit KARYA**',
  ...
  he: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם KARYA AI. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון KARYA כדי לראות פרויקטים שיצרתם באתר.',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountGenspark: 'חשבון KARYA',
    account: 'חשבון',
    login: 'התחברות',
    loginGenspark: 'התחברות עם KARYA',
    loggedIn: 'מחובר',
    loggedInGenspark: 'מחובר ל-KARYA',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-KARYA — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    starPromptTitle: 'נהנים מ-KĀRYA?',
    starPromptTitleN: 'פתחת {n} מסמכים עם KĀRYA',
    starPromptBody: 'KĀRYA חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם KĀRYA מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    aboutAttribution: "KĀRYA נגזר ומשונה מ-GenOffice, חבילת משרדים בקוד פתוח עם בינה מלאכותית שפותחה במקור על ידי Mainfunc, Inc. (KARYA). מוצר זה אינו מסונף ל-KARYA ואינו מאושר על ידה.",
    aboutLicense: "ברישיון Apache License 2.0.",
    aboutClose: "סגירה",
    tabList: 'כל הכרטיסיות',
    newTab: 'כרטיסייה חדשה',
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-KĀRYA',
    ...
    onbBody2:
      'KĀRYA עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות KARYA**',
  ...
  hi: {
    ...
    navCloud: 'KARYA Projects',
    cloudSubtitle:
      'KARYA AI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने KARYA खाते में साइन इन करें।',
    ...
    noContent: '(खाली)',
    accountGenspark: 'KARYA खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginGenspark: 'KARYA से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInGenspark: 'KARYA में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'KARYA से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    starPromptTitle: 'KĀRYA पसंद आ रहा है?',
    starPromptTitleN: 'आपने KĀRYA में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'KĀRYA मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको KĀRYA पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    aboutAttribution: "KĀRYA GenOffice से व्युत्पन्न और संशोधित है, जो मूल रूप से Mainfunc, Inc. (KARYA) द्वारा विकसित एक ओपन-सोर्स AI-नेटिव ऑफिस सुइट है। यह उत्पाद KARYA से संबद्ध या समर्थित नहीं है।",
    aboutLicense: "Apache License 2.0 के अंतर्गत लाइसेंस प्राप्त।",
    aboutClose: "बंद करें",
    tabList: 'सभी टैब',
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'KĀRYA में आपका स्वागत है',
    ...
    onbBody2:
      'KĀRYA अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: '1,000+ KARYA क्रेडिट**',
    ...
    onbNote3: '.*KARYA क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'KARYA Projects',
    cloudSubtitle: '在網頁端用 KARYA AI 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 KARYA 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountGenspark: 'KARYA 帳號',
    account: '帳號',
    login: '登入',
    loginGenspark: '登入 KARYA 帳號',
    loggedIn: '已登入',
    loggedInGenspark: '已登入 KARYA',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 KARYA，請檢查網路或代理設定',
    ...
    starPromptTitle: '喜歡 KĀRYA 嗎？',
    starPromptTitleN: '你已經用 KĀRYA 開啟了 {n} 個文件',
    starPromptBody: 'KĀRYA 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 KĀRYA，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    aboutAttribution: "KĀRYA 衍生自並修改自 GenOffice——一個由 Mainfunc, Inc.（KARYA）開發的開放原始碼 AI 原生辦公套件。本產品與 KARYA 無隸屬或背書關係。",
    aboutLicense: "依據 Apache License 2.0 許可。",
    aboutClose: "關閉",
    tabList: '全部分頁',
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 KĀRYA',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'KĀRYA 目前仍在 alpha 階段。歡迎加入 GenTeam 群聊，分享回饋，一起打造它的未來。',
    onbCredits: '1,000+ KARYA 點數**',
    onbJoinGenTeam: '加入 GenTeam',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
