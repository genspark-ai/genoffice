...
export const aiStrings = defineStrings({
  zh: {
    aiTinyfishConnect: '连接 TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: '断开 TinyFish',
    aiSumFetchUrl: '抓取网页',
    aiSumFetchUrlDone: '已抓取 {url}',
  ...
  en: {
    aiTinyfishConnect: 'Connect TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'Disconnect TinyFish',
    aiSumFetchUrl: 'Fetch URL',
    aiSumFetchUrlDone: 'Fetched {url}',
  ...
  ja: {
    aiTinyfishConnect: 'TinyFish に接続',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'TinyFish を切断',
    aiSumFetchUrl: 'URL を取得',
    aiSumFetchUrlDone: '{url} を取得しました',
  ...
  ko: {
    aiTinyfishConnect: 'TinyFish 연결',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'TinyFish 연결 해제',
    aiSumFetchUrl: 'URL 가져오기',
    aiSumFetchUrlDone: '{url} 가져옴',
  ...
  fr: {
    aiTinyfishConnect: 'Connecter TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'Déconnecter TinyFish',
    aiSumFetchUrl: 'Récupérer l’URL',
    aiSumFetchUrlDone: '{url} récupéré',
  ...
  de: {
    aiTinyfishConnect: 'TinyFish verbinden',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'TinyFish trennen',
    aiSumFetchUrl: 'URL abrufen',
    aiSumFetchUrlDone: '{url} abgerufen',
  ...
  es: {
    aiTinyfishConnect: 'Conectar TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'Desconectar TinyFish',
    aiSumFetchUrl: 'Obtener URL',
    aiSumFetchUrlDone: '{url} obtenido',
  ...
  th: {
    aiTinyfishConnect: 'เชื่อมต่อ TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'ตัดการเชื่อมต่อ TinyFish',
    aiSumFetchUrl: 'ดึงข้อมูล URL',
    aiSumFetchUrlDone: 'ดึงข้อมูล {url} แล้ว',
  ...
  id: {
    aiTinyfishConnect: 'Hubungkan TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'Putuskan TinyFish',
    aiSumFetchUrl: 'Ambil URL',
    aiSumFetchUrlDone: '{url} diambil',
  ...
  ru: {
    aiTinyfishConnect: 'Подключить TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'Отключить TinyFish',
    aiSumFetchUrl: 'Загрузить URL',
    aiSumFetchUrlDone: '{url} загружен',
  ...
  ar: {
    aiTinyfishConnect: 'ربط TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'فصل TinyFish',
    aiSumFetchUrl: 'جلب الرابط',
    aiSumFetchUrlDone: 'تم جلب {url}',
  ...
  pt: {
    ...
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'Desconectar TinyFish',
    aiSumFetchUrl: 'Buscar URL',
    aiSumFetchUrlDone: '{url} buscado',
  ...
  it: {
    aiTinyfishConnect: 'Connetti TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'Disconnetti TinyFish',
    aiSumFetchUrl: 'Recupera URL',
    aiSumFetchUrlDone: '{url} recuperato',
  ...
  pl: {
    aiTinyfishConnect: 'Połącz TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'Rozłącz TinyFish',
    aiSumFetchUrl: 'Pobierz URL',
    aiSumFetchUrlDone: 'Pobrano {url}',
  ...
  nl: {
    aiTinyfishConnect: 'TinyFish verbinden',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'TinyFish verbreken',
    aiSumFetchUrl: 'URL ophalen',
    aiSumFetchUrlDone: '{url} opgehaald',
  ...
  ms: {
    aiTinyfishConnect: 'Sambungkan TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'Putuskan TinyFish',
    aiSumFetchUrl: 'Ambil URL',
    aiSumFetchUrlDone: '{url} diambil',
  ...
  he: {
    aiTinyfishConnect: 'חבר את TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'נתק את TinyFish',
    aiSumFetchUrl: 'משיכת כתובת',
    aiSumFetchUrlDone: '{url} נמשך',
  ...
  hi: {
    aiTinyfishConnect: 'TinyFish कनेक्ट करें',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: 'TinyFish डिस्कनेक्ट करें',
    aiSumFetchUrl: 'URL लाएँ',
    aiSumFetchUrlDone: '{url} लाया गया',
  ...
  'zh-TW': {
    aiTinyfishConnect: '連接 TinyFish',
    aiTinyfishConnected: 'TinyFish ✓',
    aiTinyfishDisconnect: '中斷 TinyFish',
    aiSumFetchUrl: '抓取網頁',
    aiSumFetchUrlDone: '已抓取 {url}',
