...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiSettingsGensparkHint: '登录 Genspark 后即可使用，无需 API Key',
    aiSettingsOpenCodeHint: '连接本地 opencode 服务，无需 API Key',
    aiSettingsModelPlaceholder: '如 opencode/model-id（留空使用默认模型）',
    aiSettingsCustomModelPlaceholder: '如 deepseek-chat（留空使用默认模型）',
    aiSettingsSave: '保存',
    aiSettingsCancel: '取消',
    aiNewChatTitle: '新对话',
  ...
  en: {
    ...
    aiSettingsApiKey: 'API Key',
    aiSettingsBaseUrl: 'Base URL',
    aiSettingsGensparkHint: 'Sign in to Genspark — no API key needed',
    aiSettingsOpenCodeHint: 'Connect to your local opencode server — no API key needed',
    aiSettingsModelPlaceholder: 'e.g. opencode/model-id (blank = default)',
    aiSettingsCustomModelPlaceholder: 'e.g. deepseek-chat (blank = default)',
    aiSettingsSave: 'Save',
  ...
  ja: {
    ...
    aiSettingsGensparkHint: 'Genspark にログインして使用 — API キーは不要',
    aiSettingsOpenCodeHint: 'ローカルの opencode サーバーに接続 — API キーは不要',
    aiSettingsModelPlaceholder: '例: opencode/model-id（空欄はデフォルト）',
    aiSettingsCustomModelPlaceholder: '例: deepseek-chat（空欄はデフォルト）',
    aiSettingsSave: '保存',
  ...
  ko: {
    ...
    aiSettingsBaseUrl: 'Base URL',
    aiSettingsGensparkHint: 'Genspark에 로그인하여 사용 — API 키 불필요',
    aiSettingsOpenCodeHint: '로컬 opencode 서버에 연결 — API 키 불필요',
    aiSettingsModelPlaceholder: '예: opencode/model-id（비우면 기본값）',
    aiSettingsCustomModelPlaceholder: '예: deepseek-chat（비우면 기본값）',
    aiSettingsSave: '저장',
    aiSettingsCancel: '취소',
    aiNewChatTitle: '새 대화',
  ...
  fr: {
    ...
    aiSettingsGensparkHint: 'Connectez-vous à Genspark — aucune clé API requise',
    aiSettingsOpenCodeHint: 'Connectez-vous à votre serveur opencode local — aucune clé API requise',
    aiSettingsModelPlaceholder: 'ex. opencode/model-id (vide = défaut)',
    aiSettingsCustomModelPlaceholder: 'ex. deepseek-chat (vide = défaut)',
  ...
  de: {
    ...
    aiSettingsGensparkHint: 'Bei Genspark anmelden — kein API-Schlüssel nötig',
    aiSettingsOpenCodeHint: 'Mit lokalem opencode-Server verbinden — kein API-Schlüssel nötig',
    aiSettingsModelPlaceholder: 'z. B. opencode/model-id (leer = Standard)',
    aiSettingsCustomModelPlaceholder: 'z. B. deepseek-chat (leer = Standard)',
  ...
  es: {
    ...
    aiSettingsGensparkHint: 'Inicia sesión en Genspark — no se necesita clave API',
    aiSettingsOpenCodeHint: 'Conéctate a tu servidor opencode local — no se necesita clave API',
    aiSettingsModelPlaceholder: 'p. ej. opencode/model-id (vacío = predeterminado)',
    aiSettingsCustomModelPlaceholder: 'p. ej. deepseek-chat (vacío = predeterminado)',
  ...
  th: {
    ...
    aiSettingsBaseUrl: 'URL ฐาน',
    aiSettingsGensparkHint: 'เข้าสู่ระบบ Genspark — ไม่ต้องใช้คีย์ API',
    aiSettingsOpenCodeHint: 'เชื่อมต่อกับเซิร์ฟเวอร์ opencode ในเครื่อง — ไม่ต้องใช้คีย์ API',
    aiSettingsModelPlaceholder: 'เช่น opencode/model-id (ว่าง = ค่าเริ่มต้น)',
    aiSettingsCustomModelPlaceholder: 'เช่น deepseek-chat (ว่าง = ค่าเริ่มต้น)',
  ...
  id: {
    ...
    aiSettingsGensparkHint: 'Masuk ke Genspark — tidak perlu kunci API',
    aiSettingsOpenCodeHint: 'Hubungkan ke server opencode lokal — tidak perlu kunci API',
    aiSettingsModelPlaceholder: 'mis. opencode/model-id (kosong = lalai)',
    aiSettingsCustomModelPlaceholder: 'mis. deepseek-chat (kosong = lalai)',
  ...
  ru: {
    ...
    aiSettingsGensparkHint: 'Войдите в Genspark — API-ключ не нужен',
    aiSettingsOpenCodeHint: 'Подключитесь к локальному серверу opencode — API-ключ не нужен',
    aiSettingsModelPlaceholder: 'напр. opencode/model-id (пусто = по умолчанию)',
    aiSettingsCustomModelPlaceholder: 'напр. deepseek-chat (пусто = по умолчанию)',
  ...
  ar: {
    ...
    aiSettingsBaseUrl: 'عنوان URL الأساسي',
    aiSettingsGensparkHint: 'سجّل الدخول إلى Genspark — لا حاجة لمفتاح API',
    aiSettingsOpenCodeHint: 'اتصل بخادم opencode المحلي — لا حاجة لمفتاح API',
    aiSettingsModelPlaceholder: 'مثل opencode/model-id (فارغ = الافتراضي)',
    aiSettingsCustomModelPlaceholder: 'مثل deepseek-chat (فارغ = الافتراضي)',
    aiSettingsSave: 'حفظ',
  ...
  pt: {
    ...
    aiSettingsModel: 'Modelo',
    aiSettingsApiKey: 'Chave de API',
    aiSettingsBaseUrl: 'URL base',
    aiSettingsGensparkHint: 'Entre no Genspark — nenhuma chave de API necessária',
    aiSettingsOpenCodeHint: 'Conecte-se ao seu servidor opencode local — nenhuma chave de API necessária',
    aiSettingsModelPlaceholder: 'ex. opencode/model-id (vazio = padrão)',
    aiSettingsCustomModelPlaceholder: 'ex. deepseek-chat (vazio = padrão)',
  ...
  it: {
    ...
    aiSettingsBaseUrl: 'URL di base',
    aiSettingsGensparkHint: 'Accedi a Genspark — nessuna chiave API richiesta',
    aiSettingsOpenCodeHint: 'Connettiti al tuo server opencode locale — nessuna chiave API richiesta',
    aiSettingsModelPlaceholder: 'es. opencode/model-id (vuoto = predefinito)',
    aiSettingsCustomModelPlaceholder: 'es. deepseek-chat (vuoto = predefinito)',
  ...
  pl: {
    ...
    aiSettingsBaseUrl: 'URL bazowy',
    aiSettingsGensparkHint: 'Zaloguj się do Genspark — klucz API nie jest wymagany',
    aiSettingsOpenCodeHint: 'Połącz się z lokalnym serwerem opencode — klucz API nie jest wymagany',
    aiSettingsModelPlaceholder: 'np. opencode/model-id (puste = domyślny)',
    aiSettingsCustomModelPlaceholder: 'np. deepseek-chat (puste = domyślny)',
  ...
  nl: {
    ...
    aiSettingsBaseUrl: 'Basis-URL',
    aiSettingsGensparkHint: 'Meld u aan bij Genspark — geen API-sleutel nodig',
    aiSettingsOpenCodeHint: 'Maak verbinding met uw lokale opencode-server — geen API-sleutel nodig',
    aiSettingsModelPlaceholder: 'bijv. opencode/model-id (leeg = standaard)',
    aiSettingsCustomModelPlaceholder: 'bijv. deepseek-chat (leeg = standaard)',
  ...
  ms: {
    ...
    aiSettingsGensparkHint: 'Log masuk ke Genspark — tiada kunci API diperlukan',
    aiSettingsOpenCodeHint: 'Sambung ke pelayan opencode tempatan — tiada kunci API diperlukan',
    aiSettingsModelPlaceholder: 'cth. opencode/model-id (kosong = lalai)',
    aiSettingsCustomModelPlaceholder: 'cth. deepseek-chat (kosong = lalai)',
    aiSettingsSave: 'Simpan',
    aiSettingsCancel: 'Batal',
  ...
  he: {
    ...
    aiSettingsBaseUrl: 'כתובת בסיס',
    aiSettingsGensparkHint: 'היכנסו ל-Genspark — אין צורך במפתח API',
    aiSettingsOpenCodeHint: 'התחברו לשרת opencode המקומי — אין צורך במפתח API',
    aiSettingsModelPlaceholder: 'לדוגמה opencode/model-id (ריק = ברירת מחדל)',
    aiSettingsCustomModelPlaceholder: 'לדוגמה deepseek-chat (ריק = ברירת מחדל)',
    aiSettingsSave: 'שמור',
  ...
  hi: {
    ...
    aiSettingsBaseUrl: 'बेस URL',
    aiSettingsGensparkHint: 'Genspark में साइन इन करें — API कुंजी की आवश्यकता नहीं',
    aiSettingsOpenCodeHint: 'अपने स्थानीय opencode सर्वर से कनेक्ट करें — API कुंजी की आवश्यकता नहीं',
    aiSettingsModelPlaceholder: 'जैसे opencode/model-id (खाली = डिफ़ॉल्ट)',
    aiSettingsCustomModelPlaceholder: 'जैसे deepseek-chat (खाली = डिफ़ॉल्ट)',
  ...
  'zh-TW': {
    ...
    aiSettingsApiKey: 'API Key',
    aiSettingsBaseUrl: 'Base URL',
    aiSettingsGensparkHint: '登入 Genspark 後即可使用，無需 API Key',
    aiSettingsOpenCodeHint: '連接本機 opencode 服務，無需 API Key',
    aiSettingsModelPlaceholder: '如 opencode/model-id（留空使用預設模型）',
    aiSettingsCustomModelPlaceholder: '如 deepseek-chat（留空使用預設模型）',
    aiSettingsSave: '儲存',
    aiSettingsCancel: '取消',
    aiNewChatTitle: '新對話',
