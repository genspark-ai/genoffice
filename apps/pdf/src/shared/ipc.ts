...
export const VISUAL_SIGNATURE_CONTENT_PREFIX = 'KARYA visual signature field: '
...
export type DrawingInput =
  ...
  | {
      ...
      at: [number, number]
      contents: string
      /** Annotation author (/T); omitted → 'KARYA' */
      author?: string
...
/** Editable metadata for a KARYA static form fill embedded as a page image. */
...
/** Extract pages into a new PDF written to the KARYA save dir and opened in a new tab */
 ...
 * KARYA save dir and opened in a new tab */
...
export interface PdfApi {
  ...
  /** Read KARYA static-fill metadata stored inside the PDF. */
