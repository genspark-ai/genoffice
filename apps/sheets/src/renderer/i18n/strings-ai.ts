...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiSettingsTestButton: '测试连接',
    aiSettingsTestConnected: '已连接',
    aiSettingsTestNotRunning: '未在运行',
    aiSettingsTestRefused: '连接被拒绝',
    aiSettingsTestInvalid: '端点无效',
    aiSettingsTestAuth: '身份验证失败',
    aiSettingsTestTimeout: '连接超时',
    aiSettingsTestFailed: '连接失败',
    aiNotConfigured: 'AI 未配置 — 请在设置中选择服务商和模型以启用 AI',
    ...
    aiKARYAAccount: 'KARYA 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 KARYA 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginGenspark: '登录 KARYA',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
    aiTimeoutError: 'AI 请求超时：网络长时间无响应，已停止。请检查网络后重试',
    aiCreditsExhausted: 'KARYA 积分已用完，请前往 karya.ai/pricing 充值后重试',
    ...
    aiUnsupportedPrompt: '试试这些指令：如「set A1 to 42」「formula B1 = SUM(A1:A10)」「rename sheet to Budget」',
    aiSettingsProvider: 'AI 服务商',
    aiSettingsApiKey: 'API 密钥',
    aiSettingsApiKeyHint: 'Ollama 不需要 API 密钥',
    aiSettingsBaseUrl: '基础地址',
    aiSettingsDetectedModels: '已检测到的模型',
    aiSettingsRefresh: '刷新',
    aiSettingsNoModel: '未检测到模型',
    aiSettingsModelMissing: '所选模型未安装',
    aiSettingsTestFail: '连接失败',
    aiSettingsCancel: '取消',
    aiSettingsSave: '保存',
    aiSettingsModel: '模型',
    aiSettingsGensparkLogin: '登录',
    aiSettingsGensparkConnected: '已连接',
    aiSettingsGensparkDisconnected: '未连接',
    aiSettingsOllamaBaseUrlHint: 'Ollama 需要在本地运行',
  },
  en: {
    ...
    aiGskLoginBtn: 'Sign in to KARYA',
    ...
    aiSettingsTestNotRunning: 'Not running',
    aiSettingsTestRefused: 'Connection refused',
    aiSettingsTestInvalid: 'Invalid endpoint',
    aiSettingsTestAuth: 'Authentication failed',
    aiSettingsTestTimeout: 'Connection timed out',
    aiSettingsTestFailed: 'Connection failed',
    aiNotConfigured: 'AI not configured — choose a provider and model in Settings to enable AI',
    ...
    aiKARYAAccount: 'KARYA account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a KARYA account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiLoginGenspark: 'Sign in to KARYA',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
    ...
    aiCreditsExhausted:
      'Your KARYA credits have run out. Visit karya.ai/pricing to top up, then try again',
    ...
    aiUnsupportedPrompt: 'Try “set A1 to 42”, “formula B1 = SUM(A1:A10)”, or “rename sheet to Budget”.',
  ...
  ja: {
    ...
    aiSettingsTestButton: '接続テスト',
    aiSettingsTestConnected: '接続済み',
    aiSettingsTestNotRunning: '起動していません',
    aiSettingsTestRefused: '接続が拒否されました',
    aiSettingsTestInvalid: 'エンドポイントが無効です',
    aiSettingsTestAuth: '認証に失敗しました',
    aiSettingsTestTimeout: '接続がタイムアウトしました',
    aiSettingsTestFailed: '接続に失敗しました',
    aiNotConfigured: 'AI が設定されていません — 設定でプロバイダーとモデルを選択してください',
    ...
    aiKARYAAccount: 'KARYA アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には KARYA アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiLoginGenspark: 'KARYA にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
    ...
    aiCreditsExhausted:
      'KARYAクレジットを使い切りました。karya.ai/pricing でチャージしてから再試行してください',
    ...
    aiUnsupportedPrompt: '例:「set A1 to 42」「formula B1 = SUM(A1:A10)」「rename sheet to Budget」のように入力してください',
    aiSettingsProvider: 'AI プロバイダー',
    aiSettingsApiKey: 'API キー',
    aiSettingsApiKeyHint: 'Ollama には API キーが必要ありません',
    aiSettingsBaseUrl: 'ベース URL',
    aiSettingsDetectedModels: '検出されたモデル',
    aiSettingsRefresh: '更新',
    aiSettingsNoModel: 'モデルが検出されませんでした',
    aiSettingsModelMissing: '選択したモデルはインストールされていません',
    aiSettingsTestFail: '接続に失敗しました',
    aiSettingsCancel: 'キャンセル',
    aiSettingsSave: '保存',
    aiSettingsModel: 'モデル',
    aiSettingsGensparkLogin: 'ログイン',
    aiSettingsGensparkConnected: '接続済み',
    aiSettingsGensparkDisconnected: '未接続',
    aiSettingsOllamaBaseUrlHint: 'Ollama はローカルで実行する必要があります',
  },
  ko: {
    ...
    aiSettingsTestButton: '연결 테스트',
    aiSettingsTestConnected: '연결됨',
    aiSettingsTestNotRunning: '실행 중이 아님',
    aiSettingsTestRefused: '연결이 거부됨',
    aiSettingsTestInvalid: '잘못된 엔드포인트',
    aiSettingsTestAuth: '인증 실패',
    aiSettingsTestTimeout: '연결 시간 초과',
    aiSettingsTestFailed: '연결 실패',
    aiNotConfigured: 'AI가 구성되지 않았습니다 — 설정에서 제공업체와 모델을 선택하세요',
    ...
    aiKARYAAccount: 'KARYA 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 KARYA 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginGenspark: 'KARYA 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
    ...
    aiCreditsExhausted:
      'KARYA 크레딧을 모두 사용했습니다. karya.ai/pricing에서 충전한 후 다시 시도해 주세요',
    ...
    aiUnsupportedPrompt: '「set A1 to 42」「formula B1 = SUM(A1:A10)」「rename sheet to Budget」처럼 입력해 보세요',
    aiSettingsProvider: 'AI 제공자',
    aiSettingsApiKey: 'API 키',
    aiSettingsApiKeyHint: 'Ollama에는 API 키가 필요하지 않습니다',
    aiSettingsBaseUrl: '기본 URL',
    aiSettingsDetectedModels: '감지된 모델',
    aiSettingsRefresh: '새로고침',
    aiSettingsNoModel: '감지된 모델 없음',
    aiSettingsModelMissing: '선택한 모델이 설치되어 있지 않습니다',
    aiSettingsTestFail: '연결 실패',
    aiSettingsCancel: '취소',
    aiSettingsSave: '저장',
    aiSettingsModel: '모델',
    aiSettingsGensparkLogin: '로그인',
    aiSettingsGensparkConnected: '연결됨',
    aiSettingsGensparkDisconnected: '연결되지 않음',
    aiSettingsOllamaBaseUrlHint: 'Ollama는 로컬에서 실행해야 합니다',
  },
  fr: {
    ...
    aiGskLoginBtn: 'Se connecter à KARYA',
    ...
    aiSettingsTestButton: 'Tester la connexion',
    aiSettingsTestConnected: 'Connecté',
    aiSettingsTestNotRunning: 'Ne fonctionne pas',
    aiSettingsTestRefused: 'Connexion refusée',
    aiSettingsTestInvalid: 'Point de terminaison invalide',
    aiSettingsTestAuth: "Échec de l'authentification",
    aiSettingsTestTimeout: 'Délai de connexion dépassé',
    aiSettingsTestFailed: 'Échec de la connexion',
    aiNotConfigured: 'IA non configurée — choisissez un fournisseur et un modèle dans les paramètres',
    ...
    aiKARYAAccount: 'Compte KARYA',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte KARYA)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginGenspark: 'Se connecter à KARYA',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
    ...
    aiCreditsExhausted:
      'Vos crédits KARYA sont épuisés. Rechargez sur karya.ai/pricing puis réessayez',
    ...
    aiUnsupportedPrompt: 'Essayez par exemple « set A1 to 42 », « formula B1 = SUM(A1:A10) » ou « rename sheet to Budget ».',
    aiSettingsProvider: 'Fournisseur IA',
    aiSettingsApiKey: 'Clé API',
    aiSettingsApiKeyHint: "Ollama ne nécessite pas de clé API",
    aiSettingsBaseUrl: 'URL de base',
    aiSettingsDetectedModels: 'Modèles détectés',
    aiSettingsRefresh: 'Actualiser',
    aiSettingsNoModel: 'Aucun modèle détecté',
    aiSettingsModelMissing: 'Le modèle sélectionné n\'est pas installé',
    aiSettingsTestFail: 'Échec de la connexion',
    aiSettingsCancel: 'Annuler',
    aiSettingsSave: 'Enregistrer',
    aiSettingsModel: 'Modèle',
    aiSettingsGensparkLogin: 'Se connecter',
    aiSettingsGensparkConnected: 'Connecté',
    aiSettingsGensparkDisconnected: 'Non connecté',
    aiSettingsOllamaBaseUrlHint: 'Ollama doit être exécuté localement',
  },
  de: {
    ...
    aiGskLoginBtn: 'Bei KARYA anmelden',
    ...
    aiSettingsTestButton: 'Verbindung testen',
    aiSettingsTestConnected: 'Verbunden',
    aiSettingsTestNotRunning: 'Läuft nicht',
    aiSettingsTestRefused: 'Verbindung abgelehnt',
    aiSettingsTestInvalid: 'Ungültiger Endpunkt',
    aiSettingsTestAuth: 'Authentifizierung fehlgeschlagen',
    aiSettingsTestTimeout: 'Zeitüberschreitung der Verbindung',
    aiSettingsTestFailed: 'Verbindung fehlgeschlagen',
    aiNotConfigured: 'KI nicht konfiguriert — wählen Sie in den Einstellungen einen Anbieter und ein Modell',
    ...
    aiCreditsExhausted:
      'Deine KARYA-Credits sind aufgebraucht. Lade unter karya.ai/pricing auf und versuche es erneut',
    ...
    aiUnsupportedPrompt: 'Versuchen Sie z. B. „set A1 to 42“, „formula B1 = SUM(A1:A10)“ oder „rename sheet to Budget“.',
    aiSettingsProvider: 'KI-Anbieter',
    aiSettingsApiKey: 'API-Schlüssel',
    aiSettingsApiKeyHint: 'Ollama benötigt keinen API-Schlüssel',
    aiSettingsBaseUrl: 'Basis-URL',
    aiSettingsDetectedModels: 'Erkannte Modelle',
    aiSettingsRefresh: 'Aktualisieren',
    aiSettingsNoModel: 'Keine Modelle erkannt',
    aiSettingsModelMissing: 'Das ausgewählte Modell ist nicht installiert',
    aiSettingsTestFail: 'Verbindung fehlgeschlagen',
    aiSettingsCancel: 'Abbrechen',
    aiSettingsSave: 'Speichern',
    aiSettingsModel: 'Modell',
    aiSettingsGensparkLogin: 'Anmelden',
    aiSettingsGensparkConnected: 'Verbunden',
    aiSettingsGensparkDisconnected: 'Nicht verbunden',
    aiSettingsOllamaBaseUrlHint: 'Ollama muss lokal ausgeführt werden',
  },
  es: {
    ...
    aiGskLoginBtn: 'Iniciar sesión en KARYA',
    ...
    aiSettingsTestButton: 'Probar conexión',
    aiSettingsTestConnected: 'Conectado',
    aiSettingsTestNotRunning: 'No está en ejecución',
    aiSettingsTestRefused: 'Conexión rechazada',
    aiSettingsTestInvalid: 'Punto final no válido',
    aiSettingsTestAuth: 'Fallo de autenticación',
    aiSettingsTestTimeout: 'Tiempo de conexión agotado',
    aiSettingsTestFailed: 'Conexión fallida',
    aiNotConfigured: 'IA no configurada — elige un proveedor y un modelo en los ajustes',
    ...
    aiCreditsExhausted:
      'Tus créditos de KARYA se han agotado. Recarga en karya.ai/pricing e inténtalo de nuevo',
    ...
    aiUnsupportedPrompt: 'Prueba por ejemplo «set A1 to 42», «formula B1 = SUM(A1:A10)» o «rename sheet to Budget».',
    aiSettingsProvider: 'Proveedor de IA',
    aiSettingsApiKey: 'Clave API',
    aiSettingsApiKeyHint: 'Ollama no requiere una clave API',
    aiSettingsBaseUrl: 'URL base',
    aiSettingsDetectedModels: 'Modelos detectados',
    aiSettingsRefresh: 'Actualizar',
    aiSettingsNoModel: 'No se detectaron modelos',
    aiSettingsModelMissing: 'El modelo seleccionado no está instalado',
    aiSettingsTestFail: 'Conexión fallida',
    aiSettingsCancel: 'Cancelar',
    aiSettingsSave: 'Guardar',
    aiSettingsModel: 'Modelo',
    aiSettingsGensparkLogin: 'Iniciar sesión',
    aiSettingsGensparkConnected: 'Conectado',
    aiSettingsGensparkDisconnected: 'No conectado',
    aiSettingsOllamaBaseUrlHint: 'Ollama debe ejecutarse localmente',
  },
  th: {
    ...
    aiGskLoginBtn: 'ลงชื่อเข้าใช้ KARYA',
    ...
    aiSettingsTestButton: 'ทดสอบการเชื่อมต่อ',
    aiSettingsTestConnected: 'เชื่อมต่อแล้ว',
    aiSettingsTestNotRunning: 'ไม่ได้ทำงาน',
    aiSettingsTestRefused: 'การเชื่อมต่อถูกปฏิเสธ',
    aiSettingsTestInvalid: 'จุดเชื่อมต่อไม่ถูกต้อง',
    aiSettingsTestAuth: 'การตรวจสอบสิทธิ์ล้มเหลว',
    aiSettingsTestTimeout: 'การเชื่อมต่อหมดเวลา',
    aiSettingsTestFailed: 'การเชื่อมต่อล้มเหลว',
    aiNotConfigured: 'ยังไม่ได้กำหนดค่า AI — เลือกผู้ให้บริการและโมเดลในการตั้งค่า',
    ...
    aiCreditsExhausted:
      'เครดิต KARYA ของคุณหมดแล้ว โปรดเติมเครดิตที่ karya.ai/pricing แล้วลองใหม่',
    ...
    aiUnsupportedPrompt: 'ลองพิมพ์เช่น "set A1 to 42" "formula B1 = SUM(A1:A10)" หรือ "rename sheet to Budget"',
    aiSettingsProvider: 'ผู้ให้บริการ AI',
    aiSettingsApiKey: 'คีย์ API',
    aiSettingsApiKeyHint: 'Ollama ไม่ต้องการคีย์ API',
    aiSettingsBaseUrl: 'URL พื้นฐาน',
    aiSettingsDetectedModels: 'โมเดลที่ตรวจพบ',
    aiSettingsRefresh: 'รีเฟรช',
    aiSettingsNoModel: 'ไม่พบโมเดล',
    aiSettingsModelMissing: 'โมเดลที่เลือกยังไม่ได้ติดตั้ง',
    aiSettingsTestFail: 'การเชื่อมต่อล้มเหลว',
    aiSettingsCancel: 'ยกเลิก',
    aiSettingsSave: 'บันทึก',
    aiSettingsModel: 'โมเดล',
    aiSettingsGensparkLogin: 'เข้าสู่ระบบ',
    aiSettingsGensparkConnected: 'เชื่อมต่อแล้ว',
    aiSettingsGensparkDisconnected: 'ไม่ได้เชื่อมต่อ',
    aiSettingsOllamaBaseUrlHint: 'Ollama ต้องทำงานบนเครื่อง local',
  },
  id: {
    ...
    aiSettingsTestButton: 'Uji Koneksi',
    aiSettingsTestConnected: 'Terhubung',
    aiSettingsTestNotRunning: 'Tidak berjalan',
    aiSettingsTestRefused: 'Koneksi ditolak',
    aiSettingsTestInvalid: 'Titik akhir tidak valid',
    aiSettingsTestAuth: 'Autentikasi gagal',
    aiSettingsTestTimeout: 'Koneksi waktu habis',
    aiSettingsTestFailed: 'Koneksi gagal',
    aiNotConfigured: 'AI belum dikonfigurasi — pilih penyedia dan model di pengaturan',
    ...
    aiCreditsExhausted:
      'Kredit KARYA Anda telah habis. Isi ulang di karya.ai/pricing lalu coba lagi',
    ...
    aiUnsupportedPrompt: 'Coba seperti "set A1 to 42", "formula B1 = SUM(A1:A10)", atau "rename sheet to Budget".',
    aiSettingsProvider: 'Penyedia AI',
    aiSettingsApiKey: 'Kunci API',
    aiSettingsApiKeyHint: 'Ollama tidak memerlukan kunci API',
    aiSettingsBaseUrl: 'URL Dasar',
    aiSettingsDetectedModels: 'Model Terdeteksi',
    aiSettingsRefresh: 'Segarkan',
    aiSettingsNoModel: 'Tidak ada model terdeteksi',
    aiSettingsModelMissing: 'Model yang dipilih tidak terpasang',
    aiSettingsTestFail: 'Koneksi gagal',
    aiSettingsCancel: 'Batal',
    aiSettingsSave: 'Simpan',
    aiSettingsModel: 'Model',
    aiSettingsGensparkLogin: 'Masuk',
    aiSettingsGensparkConnected: 'Terhubung',
    aiSettingsGensparkDisconnected: 'Tidak terhubung',
    aiSettingsOllamaBaseUrlHint: 'Ollama harus berjalan secara lokal',
  },
  ru: {
    ...
    aiSettingsTestButton: 'Проверить подключение',
    aiSettingsTestConnected: 'Подключено',
    aiSettingsTestNotRunning: 'Не запущено',
    aiSettingsTestRefused: 'Соединение отклонено',
    aiSettingsTestInvalid: 'Недопустимая конечная точка',
    aiSettingsTestAuth: 'Ошибка аутентификации',
    aiSettingsTestTimeout: 'Истекло время соединения',
    aiSettingsTestFailed: 'Ошибка подключения',
    aiNotConfigured: 'ИИ не настроен — выберите провайдера и модель в настройках',
    ...
    aiKARYAAccount: 'Учётная запись KARYA',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись KARYA)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginGenspark: 'Войти в KARYA',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
    ...
    aiCreditsExhausted:
      'Кредиты KARYA исчерпаны. Пополните баланс на karya.ai/pricing и повторите попытку',
    ...
    aiUnsupportedPrompt: 'Попробуйте, например: «set A1 to 42», «formula B1 = SUM(A1:A10)» или «rename sheet to Budget».',
    aiSettingsProvider: 'Провайдер ИИ',
    aiSettingsApiKey: 'API-ключ',
    aiSettingsApiKeyHint: 'Ollama не требует API-ключ',
    aiSettingsBaseUrl: 'Базовый URL',
    aiSettingsDetectedModels: 'Обнаруженные модели',
    aiSettingsRefresh: 'Обновить',
    aiSettingsNoModel: 'Модели не обнаружены',
    aiSettingsModelMissing: 'Выбранная модель не установлена',
    aiSettingsTestFail: 'Ошибка подключения',
    aiSettingsCancel: 'Отмена',
    aiSettingsSave: 'Сохранить',
    aiSettingsModel: 'Модель',
    aiSettingsGensparkLogin: 'Войти',
    aiSettingsGensparkConnected: 'Подключено',
    aiSettingsGensparkDisconnected: 'Не подключено',
    aiSettingsOllamaBaseUrlHint: 'Ollama должен работать локально',
  },
  ar: {
    ...
    aiGskLoginBtn: 'تسجيل الدخول إلى KARYA',
    ...
    aiSettingsTestButton: 'اختبار الاتصال',
    aiSettingsTestConnected: 'متصل',
    aiSettingsTestNotRunning: 'غير مشغّل',
    aiSettingsTestRefused: 'تم رفض الاتصال',
    aiSettingsTestInvalid: 'نقطة نهاية غير صالحة',
    aiSettingsTestAuth: 'فشل المصادقة',
    aiSettingsTestTimeout: 'انتهت مهلة الاتصال',
    aiSettingsTestFailed: 'فشل الاتصال',
    aiNotConfigured: 'لم يتم تكوين الذكاء الاصطناعي — اختر مزودًا ونموذجًا في الإعدادات',
    ...
    aiCreditsExhausted:
      'نفدت أرصدة KARYA لديك. يرجى إعادة الشحن عبر karya.ai/pricing ثم المحاولة مجددًا',
    ...
    aiUnsupportedPrompt: 'جرّب مثلًا: «set A1 to 42» أو «formula B1 = SUM(A1:A10)» أو «rename sheet to Budget».',
    aiSettingsProvider: 'مزود الذكاء الاصطناعي',
    aiSettingsApiKey: 'مفتاح API',
    aiSettingsApiKeyHint: 'Ollama لا يتطلب مفتاح API',
    aiSettingsBaseUrl: 'الرابط الأساسي',
    aiSettingsDetectedModels: 'النماذج المكتشفة',
    aiSettingsRefresh: 'تحديث',
    aiSettingsNoModel: 'لم يتم اكتشاف نماذج',
    aiSettingsModelMissing: 'النموذج المحدد غير مثبت',
    aiSettingsTestFail: 'فشل الاتصال',
    aiSettingsCancel: 'إلغاء',
    aiSettingsSave: 'حفظ',
    aiSettingsModel: 'النموذج',
    aiSettingsGensparkLogin: 'تسجيل الدخول',
    aiSettingsGensparkConnected: 'متصل',
    aiSettingsGensparkDisconnected: 'غير متصل',
    aiSettingsOllamaBaseUrlHint: 'يجب أن يعمل Ollama محلياً',
  },
  pt: {
    ...
    aiSettingsTestButton: 'Testar conexão',
    aiSettingsTestConnected: 'Conectado',
    aiSettingsTestNotRunning: 'Não está em execução',
    aiSettingsTestRefused: 'Conexão recusada',
    aiSettingsTestInvalid: 'Endpoint inválido',
    aiSettingsTestAuth: 'Falha de autenticação',
    aiSettingsTestTimeout: 'Tempo de conexão esgotado',
    aiSettingsTestFailed: 'Falha na conexão',
    aiNotConfigured: 'IA não configurada — escolha um provedor e um modelo nas configurações',
    ...
    aiCreditsExhausted:
      'Seus créditos KARYA acabaram. Recarregue em karya.ai/pricing e tente novamente',
    ...
    aiUnsupportedPrompt: 'Tente por exemplo "set A1 to 42", "formula B1 = SUM(A1:A10)" ou "rename sheet to Budget".',
    aiSettingsProvider: 'Provedor de IA',
    aiSettingsApiKey: 'Chave API',
    aiSettingsApiKeyHint: 'Ollama não requer chave API',
    aiSettingsBaseUrl: 'URL Base',
    aiSettingsDetectedModels: 'Modelos Detectados',
    aiSettingsRefresh: 'Atualizar',
    aiSettingsNoModel: 'Nenhum modelo detectado',
    aiSettingsModelMissing: 'O modelo selecionado não está instalado',
    aiSettingsTestFail: 'Falha na conexão',
    aiSettingsCancel: 'Cancelar',
    aiSettingsSave: 'Salvar',
    aiSettingsModel: 'Modelo',
    aiSettingsGensparkLogin: 'Entrar',
    aiSettingsGensparkConnected: 'Conectado',
    aiSettingsGensparkDisconnected: 'Desconectado',
    aiSettingsOllamaBaseUrlHint: 'Ollama deve ser executado localmente',
  },
  it: {
    ...
    aiSettingsTestButton: 'Prova connessione',
    aiSettingsTestConnected: 'Connesso',
    aiSettingsTestNotRunning: 'Non in esecuzione',
    aiSettingsTestRefused: 'Connessione rifiutata',
    aiSettingsTestInvalid: 'Endpoint non valido',
    aiSettingsTestAuth: 'Autenticazione non riuscita',
    aiSettingsTestTimeout: 'Tempo di connessione scaduto',
    aiSettingsTestFailed: 'Connessione fallita',
    aiNotConfigured: 'IA non configurata — scegli un provider e un modello nelle impostazioni',
    ...
    aiCreditsExhausted:
      'I tuoi crediti KARYA sono esauriti. Ricarica su karya.ai/pricing e riprova',
    ...
    aiUnsupportedPrompt: 'Prova ad esempio con "set A1 to 42", "formula B1 = SUM(A1:A10)" o "rename sheet to Budget".',
    aiSettingsProvider: 'Fornitore AI',
    aiSettingsApiKey: 'Chiave API',
    aiSettingsApiKeyHint: 'Ollama non richiede una chiave API',
    aiSettingsBaseUrl: 'URL Base',
    aiSettingsDetectedModels: 'Modelli Rilevati',
    aiSettingsRefresh: 'Aggiorna',
    aiSettingsNoModel: 'Nessun modello rilevato',
    aiSettingsModelMissing: 'Il modello selezionato non è installato',
    aiSettingsTestFail: 'Connessione fallita',
    aiSettingsCancel: 'Annulla',
    aiSettingsSave: 'Salva',
    aiSettingsModel: 'Modello',
    aiSettingsGensparkLogin: 'Accedi',
    aiSettingsGensparkConnected: 'Connesso',
    aiSettingsGensparkDisconnected: 'Non connesso',
    aiSettingsOllamaBaseUrlHint: 'Ollama deve essere eseguito localmente',
  },
  pl: {
    ...
    aiGskLoginBtn: 'Zaloguj się do KARYA',
    ...
    aiSettingsTestButton: 'Testuj połączenie',
    aiSettingsTestConnected: 'Połączono',
    aiSettingsTestNotRunning: 'Nie działa',
    aiSettingsTestRefused: 'Połączenie odrzucone',
    aiSettingsTestInvalid: 'Nieprawidłowy punkt końcowy',
    aiSettingsTestAuth: 'Błąd uwierzytelniania',
    aiSettingsTestTimeout: 'Przekroczono czas połączenia',
    aiSettingsTestFailed: 'Połączenie nieudane',
    aiNotConfigured: 'AI nie jest skonfigurowane — wybierz dostawcę i model w ustawieniach',
    ...
    aiCreditsExhausted:
      'Twoje kredyty KARYA wyczerpały się. Doładuj konto na karya.ai/pricing i spróbuj ponownie',
    ...
    aiSettingsApiKeyHint: 'Ollama nie wymaga klucza API',
    aiSettingsBaseUrl: 'URL Podstawowy',
    aiSettingsDetectedModels: 'Wykryte modele',
    aiSettingsRefresh: 'Odśwież',
    aiSettingsNoModel: 'Nie wykryto modeli',
    aiSettingsModelMissing: 'Wybrany model nie jest zainstalowany',
    aiSettingsTestFail: 'Połączenie nieudane',
    aiSettingsCancel: 'Anuluj',
    aiSettingsSave: 'Zapisz',
    aiSettingsModel: 'Model',
    aiSettingsGensparkLogin: 'Zaloguj się',
    aiSettingsGensparkConnected: 'Połączono',
    aiSettingsGensparkDisconnected: 'Nie połączono',
    aiSettingsOllamaBaseUrlHint: 'Ollama musi być uruchomiona lokalnie',
  },
  nl: {
    ...
    aiGskLoginBtn: 'Aanmelden bij KARYA',
    ...
    aiSettingsTestButton: 'Verbinding testen',
    aiSettingsTestConnected: 'Verbonden',
    aiSettingsTestNotRunning: 'Niet actief',
    aiSettingsTestRefused: 'Verbinding geweigerd',
    aiSettingsTestInvalid: 'Ongeldig eindpunt',
    aiSettingsTestAuth: 'Authenticatie mislukt',
    aiSettingsTestTimeout: 'Time-out bij verbinding',
    aiSettingsTestFailed: 'Verbinding mislukt',
    aiNotConfigured: 'AI niet geconfigureerd — kies een provider en model in de instellingen',
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een KARYA-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginGenspark: 'Aanmelden bij KARYA',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
    ...
    aiCreditsExhausted:
      'Je KARYA-credits zijn op. Waardeer op via karya.ai/pricing en probeer het opnieuw',
    ...
    aiUnsupportedPrompt: 'Probeer bijvoorbeeld "set A1 to 42", "formula B1 = SUM(A1:A10)" of "rename sheet to Budget".',
    aiSettingsProvider: 'AI-aanbieder',
    aiSettingsApiKey: 'API-sleutel',
    aiSettingsApiKeyHint: 'Ollama heeft geen API-sleutel nodig',
    aiSettingsBaseUrl: 'Basis-URL',
    aiSettingsDetectedModels: 'Gedetecteerde modellen',
    aiSettingsRefresh: 'Vernieuwen',
    aiSettingsNoModel: 'Geen modellen gedetecteerd',
    aiSettingsModelMissing: 'Het geselecteerde model is niet geïnstalleerd',
    aiSettingsTestFail: 'Verbinding mislukt',
    aiSettingsCancel: 'Annuleren',
    aiSettingsSave: 'Opslaan',
    aiSettingsModel: 'Model',
    aiSettingsGensparkLogin: 'Inloggen',
    aiSettingsGensparkConnected: 'Verbonden',
    aiSettingsGensparkDisconnected: 'Niet verbonden',
    aiSettingsOllamaBaseUrlHint: 'Ollama moet lokaal draaien',
  },
  ms: {
    ...
    aiGskLoginBtn: 'Log masuk ke KARYA',
    ...
    aiSettingsTestButton: 'Uji Sambungan',
    aiSettingsTestConnected: 'Dihubungkan',
    aiSettingsTestNotRunning: 'Tidak berjalan',
    aiSettingsTestRefused: 'Sambungan ditolak',
    aiSettingsTestInvalid: 'Titik akhir tidak sah',
    aiSettingsTestAuth: 'Pengesahan gagal',
    aiSettingsTestTimeout: 'Masa sambungan tamat',
    aiSettingsTestFailed: 'Sambungan gagal',
    aiNotConfigured: 'AI belum dikonfigurasi — pilih pembekal dan model dalam tetapan',
    ...
    aiCreditsExhausted:
      'Kredit KARYA anda telah habis. Tambah nilai di karya.ai/pricing dan cuba lagi',
    ...
    aiToolWebSearchDone: 'Mencari "{query}" ({count} hasil)',
    aiUnsupportedPrompt: 'Cuba seperti "set A1 to 42", "formula B1 = SUM(A1:A10)" atau "rename sheet to Budget".',
    aiSettingsProvider: 'Pembekal AI',
    aiSettingsApiKey: 'Kunci API',
    aiSettingsApiKeyHint: 'Ollama tidak memerlukan kunci API',
    aiSettingsBaseUrl: 'URL Asas',
    aiSettingsDetectedModels: 'Model Dikesan',
    aiSettingsRefresh: 'Muat Semula',
    aiSettingsNoModel: 'Tiada model dikesan',
    aiSettingsModelMissing: 'Model yang dipilih tidak dipasang',
    aiSettingsTestFail: 'Sambungan gagal',
    aiSettingsCancel: 'Batal',
    aiSettingsSave: 'Simpan',
    aiSettingsModel: 'Model',
    aiSettingsGensparkLogin: 'Log masuk',
    aiSettingsGensparkConnected: 'Dihubungkan',
    aiSettingsGensparkDisconnected: 'Tidak dihubungkan',
    aiSettingsOllamaBaseUrlHint: 'Ollama mesti berjalan secara tempatan',
  },
  he: {
    ...
    aiSettingsTestButton: 'בדיקת חיבור',
    aiSettingsTestConnected: 'מחובר',
    aiSettingsTestNotRunning: 'אינו פועל',
    aiSettingsTestRefused: 'החיבור נדחה',
    aiSettingsTestInvalid: 'נקודת קצה לא חוקית',
    aiSettingsTestAuth: 'האימות נכשל',
    aiSettingsTestTimeout: 'פסק זמן לחיבור',
    aiSettingsTestFailed: 'החיבור נכשל',
    aiNotConfigured: 'ה-AI לא הוגדר — בחר ספק ודגם בהגדרות',
    ...
    aiUnsupportedPrompt: 'נסו למשל: "set A1 to 42", "formula B1 = SUM(A1:A10)" או "rename sheet to Budget".',
    aiSettingsProvider: 'ספק בינה מלאכותית',
    aiSettingsApiKey: 'מפתח API',
    aiSettingsApiKeyHint: 'Ollama אינו דורש מפתח API',
    aiSettingsBaseUrl: 'כתובת URL בסיסית',
    aiSettingsDetectedModels: 'מודלים שזוהו',
    aiSettingsRefresh: 'רענון',
    aiSettingsNoModel: 'לא זוהו מודלים',
    aiSettingsModelMissing: 'המודל שנבחר אינו מותקן',
    aiSettingsTestFail: 'החיבור נכשל',
    aiSettingsCancel: 'ביטול',
    aiSettingsSave: 'שמירה',
    aiSettingsModel: 'מודל',
    aiSettingsGensparkLogin: 'התחבר',
    aiSettingsGensparkConnected: 'מחובר',
    aiSettingsGensparkDisconnected: 'לא מחובר',
    aiSettingsOllamaBaseUrlHint: 'Ollama חייב לפעול מקומית',
  },
  hi: {
    ...
    aiGskLoginBtn: 'KARYA में साइन इन करें',
    ...
    aiSettingsTestButton: 'कनेक्शन जांचें',
    aiSettingsTestConnected: 'जुड़ा हुआ',
    aiSettingsTestNotRunning: 'चालू नहीं है',
    aiSettingsTestRefused: 'कनेक्शन अस्वीकार हुआ',
    aiSettingsTestInvalid: 'अमान्य एंडपॉइंट',
    aiSettingsTestAuth: 'प्रमाणीकरण विफल',
    aiSettingsTestTimeout: 'कनेक्शन टाइम आउट',
    aiSettingsTestFailed: 'कनेक्शन विफल',
    aiNotConfigured: 'AI कॉन्फ़िगर नहीं है — सेटिंग्स में प्रदाता और मॉडल चुनें',
    ...
    aiCreditsExhausted:
      'आपके KARYA क्रेडिट समाप्त हो गए हैं। karya.ai/pricing पर रिचार्ज करें और फिर से प्रयास करें',
    ...
    aiUnsupportedPrompt: 'उदाहरण के लिए "set A1 to 42", "formula B1 = SUM(A1:A10)" या "rename sheet to Budget" आज़माएँ।',
    aiSettingsProvider: 'AI प्रदाता',
    aiSettingsApiKey: 'API कुंजी',
    aiSettingsApiKeyHint: 'Ollama को API कुंजी की आवश्यकता नहीं है',
    aiSettingsBaseUrl: 'आधार URL',
    aiSettingsDetectedModels: 'पता चले मॉडल',
    aiSettingsRefresh: 'रीफ्रेश',
    aiSettingsNoModel: 'कोई मॉडल नहीं मिला',
    aiSettingsModelMissing: 'चयनित मॉडल स्थापित नहीं है',
    aiSettingsTestFail: 'कनेक्शन विफल',
    aiSettingsCancel: 'रद्द करें',
    aiSettingsSave: 'सहेजें',
    aiSettingsModel: 'मॉडल',
    aiSettingsGensparkLogin: 'लॉग इन',
    aiSettingsGensparkConnected: 'जुड़ा हुआ',
    aiSettingsGensparkDisconnected: 'जुड़ा नहीं हुआ',
    aiSettingsOllamaBaseUrlHint: 'Ollama स्थानीय रूप से चलना चाहिए',
  },
  'zh-TW': {
    aiComposerPlaceholderBuild: '描述要生成的表格、資料或圖表…',
    aiEmptyBuildTitle: '讓 AI 幫你從零建表',
    aiEmptyBuildBody: '描述想要的表格、資料或圖表，AI 直接生成。',
    aiGskLoginBtn: '登入 KARYA',
    ...
    aiSettingsTestButton: '測試連線',
    aiSettingsTestConnected: '已連線',
    aiSettingsTestNotRunning: '未在執行',
    aiSettingsTestRefused: '連線被拒絕',
    aiSettingsTestInvalid: '端點無效',
    aiSettingsTestAuth: '驗證失敗',
    aiSettingsTestTimeout: '連線逾時',
    aiSettingsTestFailed: '連線失敗',
    aiNotConfigured: 'AI 未配置 — 請在設定中選擇服務商和模型以啟用 AI',
    aiSettingsTitle: 'AI 設定',
    aiSetUp: '設定 AI',
    aiNewChat: '新對話',
    ...
    aiKARYAAccount: 'KARYA 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 KARYA 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginGenspark: '登入 KARYA',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
    aiTimeoutError: 'AI 請求逾時：網路長時間無回應，已停止。請檢查網路後重試',
    aiCreditsExhausted: 'KARYA 點數已用完，請前往 karya.ai/pricing 儲值後重試',
    ...
    aiUnsupportedPrompt: '試試這些指令：如「set A1 to 42」「formula B1 = SUM(A1:A10)」「rename sheet to Budget」',
    aiSettingsProvider: 'AI 服務商',
    aiSettingsApiKey: 'API 金鑰',
    aiSettingsApiKeyHint: 'Ollama 不需要 API 金鑰',
    aiSettingsBaseUrl: '基礎網址',
    aiSettingsDetectedModels: '已偵測到的模型',
    aiSettingsRefresh: '重新整理',
    aiSettingsNoModel: '未偵測到模型',
    aiSettingsModelMissing: '所選模型未安裝',
    aiSettingsTestFail: '連線失敗',
    aiSettingsCancel: '取消',
    aiSettingsSave: '儲存',
    aiSettingsModel: '模型',
    aiSettingsGensparkLogin: '登入',
    aiSettingsGensparkConnected: '已連線',
    aiSettingsGensparkDisconnected: '未連線',
    aiSettingsOllamaBaseUrlHint: 'Ollama 必須在本機執行',
  },
})
