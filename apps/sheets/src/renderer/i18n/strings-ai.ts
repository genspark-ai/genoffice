...
export const aiStrings = defineStrings({
  zh: {
    aiInterruptedNote: '连接中断: {error}',
    aiResumeNow: '继续执行',
    aiContinue: '继续',
    aiTruncatedNote: '（回复因长度限制被截断，可能不完整。）',
    ...
    aiNoProviderTitle: '尚未配置 AI 提供者，请在 AI 设置中选择一个。',
    aiNoProviderButton: '打开 AI 设置',
    ...
    aiSetUp: '设置 AI',
    aiNewChat: '新对话',
    aiMemoryBadgeTip: '{n} 条项目记忆（AI 会记住这些内容）',
    ...
    aiThinkingAria: '思考中',
    aiThinking: '思考中…',
    aiThoughtFor: '已思考 {n} 秒',
    aiStatusAnalyzing: '正在分析请求…',
    aiStatusRunning: '正在执行 {tool}…',
    aiStatusContinuing: '继续处理中…',
  ...
  en: {
    aiInterruptedNote: 'Connection interrupted: {error}',
    aiResumeNow: 'Resume',
    aiContinue: 'Continue',
    ...
    aiNoProviderTitle: 'No AI provider configured — open AI settings to choose one.',
    aiNoProviderButton: 'Open AI settings',
    ...
    aiMemoryBadgeTip: 'Project memory: {n} entries (the AI remembers these)',
    ...
    aiThinking: 'Thinking…',
    aiThoughtFor: 'Thought for {n}s',
    aiStatusAnalyzing: 'Analyzing your request…',
    aiStatusRunning: 'Running {tool}…',
    aiStatusContinuing: 'Continuing…',
  ...
  ja: {
    aiInterruptedNote: '接続が中断されました: {error}',
    aiResumeNow: '再開',
    aiContinue: '続ける',
    aiTruncatedNote: '（返信が長さ制限により途中で切断されました。）',
    ...
    aiNoProviderTitle: 'AI プロバイダーが未設定です。AI 設定から選択してください。',
    aiNoProviderButton: 'AI 設定を開く',
    ...
    aiSetUp: 'AI を設定',
    aiNewChat: '新しい会話',
    aiMemoryBadgeTip: 'プロジェクトのメモリー: {n} 件（AI が記憶しています）',
    ...
    aiThinkingAria: '思考中',
    aiThinking: '思考中…',
    aiThoughtFor: '考えた時間 {n}秒',
    aiStatusAnalyzing: 'リクエストを分析中…',
    aiStatusRunning: '{tool} を実行中…',
    aiStatusContinuing: '続行中…',
  ...
  ko: {
    aiInterruptedNote: '연결이 중단되었습니다: {error}',
    aiResumeNow: '재개',
    aiContinue: '계속',
    aiTruncatedNote: '(길이 제한으로 인해 답변이 잘렸습니다.)',
    ...
    aiNoProviderTitle: 'AI  제공자가 설정되지 않았습니다. AI 설정에서 선택하세요.',
    aiNoProviderButton: 'AI 설정 열기',
    ...
    aiSetUp: 'AI 설정하기',
    aiNewChat: '새 대화',
    aiMemoryBadgeTip: '프로젝트 메모리: {n}개 (AI가 기억합니다)',
    ...
    aiThinkingAria: '생각 중',
    aiThinking: '생각 중…',
    aiThoughtFor: '생각 시간 {n}초',
    aiStatusAnalyzing: '요청 분석 중…',
    aiStatusRunning: '{tool} 실행 중…',
    aiStatusContinuing: '계속 진행 중…',
  ...
  fr: {
    aiInterruptedNote: 'Connexion interrompue : {error}',
    aiResumeNow: 'Reprendre',
    aiContinue: 'Continuer',
    aiTruncatedNote: '(La réponse a été tronquée par la limite de longueur.)',
    ...
    aiNoProviderTitle: 'Aucun fournisseur d\'IA configuré — ouvrez les paramètres IA pour en choisir un.',
    aiNoProviderButton: 'Ouvrir les paramètres IA',
    ...
    aiMemoryBadgeTip: "Mémoire du projet : {n} éléments (l’IA s’en souvient)",
    ...
    aiThoughtFor: 'Réfléchi pendant {n}s',
    aiStatusAnalyzing: 'Analyse de votre demande…',
    aiStatusRunning: 'Exécution de {tool}…',
    aiStatusContinuing: 'Poursuite…',
  ...
  de: {
    aiInterruptedNote: 'Verbindung unterbrochen: {error}',
    aiResumeNow: 'Fortsetzen',
    aiContinue: 'Fortsetzen',
    aiTruncatedNote: '(Die Antwort wurde durch das Längenlimit abgeschnitten.)',
    ...
    aiNoProviderTitle: 'Er ist noch kein KI-Anbieter konfiguriert — öffnen Sie die KI-Einstellungen, um einen zu wählen.',
    aiNoProviderButton: 'KI-Einstellungen öffnen',
    ...
    aiMemoryBadgeTip: 'Projektspeicher: {n} Einträge (die KI merkt sich diese)',
    ...
    aiThoughtFor: 'Nachgedacht für {n}s',
    aiStatusAnalyzing: 'Anfrage wird analysiert…',
    aiStatusRunning: '{tool} wird ausgeführt…',
    aiStatusContinuing: 'Fortsetzung…',
  ...
  es: {
    aiInterruptedNote: 'Conexión interrumpida: {error}',
    aiResumeNow: 'Reanudar',
    aiContinue: 'Continuar',
    aiTruncatedNote: '(La respuesta fue truncada por el límite de longitud.)',
    ...
    aiNoProviderTitle: 'Ningún proveedor de IA configurado — abre los ajustes de IA para elegir uno.',
    aiNoProviderButton: 'Abrir los ajustes de IA',
    ...
    aiMemoryBadgeTip: 'Memoria del proyecto: {n} entradas (la IA las recuerda)',
    ...
    aiThinking: 'Pensando…',
    aiThoughtFor: 'Pensado durante {n}s',
    aiStatusAnalyzing: 'Analizando tu solicitud…',
    aiStatusRunning: 'Ejecutando {tool}…',
    aiStatusContinuing: 'Continuando…',
  ...
  th: {
    aiInterruptedNote: 'ขาดการเชื่อมต่อ: {error}',
    aiResumeNow: 'ดำเนินการต่อ',
    aiContinue: 'ดำเนินการต่อ',
    aiTruncatedNote: '(คำตอบถูกตัดเนื่องจากขีดจำกัดความยาว)',
    ...
    aiNoProviderTitle: 'ยังไม่ได้ตั้งค่า AI provider — เปิดการตั้งค่า AI เพื่อเลือก',
    aiNoProviderButton: 'เปิดการตั้งค่า AI',
    ...
    aiMemoryBadgeTip: 'ความทรงจำของโปรเจกต์: {n} รายการ (AI จำสิ่งเหล่านี้ได้)',
    ...
    aiThinking: 'กำลังคิด…',
    aiThoughtFor: 'คิดเป็นเวลา {n} วินาที',
    aiStatusAnalyzing: 'กำลังวิเคราะห์คำขอ…',
    aiStatusRunning: 'กำลังเรียกใช้ {tool}…',
    aiStatusContinuing: 'กำลังดำเนินการต่อ…',
  ...
  id: {
    aiInterruptedNote: 'Koneksi terputus: {error}',
    aiResumeNow: 'Lanjutkan',
    aiContinue: 'Lanjutkan',
    aiTruncatedNote: '(Balasan terpotong karena batas panjang.)',
    ...
    aiNoProviderTitle: 'Belum ada penyedia AI yang dikonfigurasi — buka pengaturan AI untuk memilih.',
    aiNoProviderButton: 'Buka pengaturan AI',
    ...
    aiMemoryBadgeTip: 'Memori proyek: {n} entri (AI mengingatnya)',
    ...
    aiThinking: 'Berpikir…',
    aiThoughtFor: 'Berpikir selama {n}d',
    aiStatusAnalyzing: 'Menganalisis permintaan…',
    aiStatusRunning: 'Menjalankan {tool}…',
    aiStatusContinuing: 'Melanjutkan…',
  ...
  ru: {
    aiInterruptedNote: 'Соединение прервано: {error}',
    aiResumeNow: 'Продолжить',
    aiContinue: 'Продолжить',
    aiTruncatedNote: '(Ответ был обрезан из-за ограничения длины.)',
    ...
    aiNoProviderTitle: 'Поставщик ИИ не настроен — откройте настройки ИИ и выберите.',
    aiNoProviderButton: 'Открыть настройки ИИ',
    ...
    aiMemoryBadgeTip: 'Память проекта: {n} записей (ИИ их запоминает)',
    ...
    aiThinking: 'Думает…',
    aiThoughtFor: 'Размышлял {n}с',
    aiStatusAnalyzing: 'Анализирую запрос…',
    aiStatusRunning: 'Выполняю {tool}…',
    aiStatusContinuing: 'Продолжаю…',
  ...
  ar: {
    aiInterruptedNote: 'انقطع الاتصال: {error}',
    aiResumeNow: 'استئناف',
    aiContinue: 'متابعة',
    aiTruncatedNote: '(تم اقتطاع الرد بسبب حد الطول.)',
    ...
    aiNoProviderTitle: 'لم يتم تكوين مزود الذكاء الاصطناعي — افتح إعدادات الذكاء الاصطناعي للاختيار.',
    aiNoProviderButton: 'فتح إعدادات الذكاء الاصطناعي',
    ...
    aiMemoryBadgeTip: 'ذاكرة المشروع: {n} عناصر (يتذكرها الذكاء الاصطناعي)',
    ...
    aiThinking: 'يفكّر…',
    aiThoughtFor: 'تم التفكير لمدة {n} ثانية',
    aiStatusAnalyzing: 'جارٍ تحليل طلبك…',
    aiStatusRunning: 'جارٍ تشغيل {tool}…',
    aiStatusContinuing: 'جارٍ المتابعة…',
  ...
  pt: {
    aiInterruptedNote: 'Conexão interrompida: {error}',
    aiResumeNow: 'Continuar',
    aiContinue: 'Continuar',
    aiTruncatedNote: '(A resposta foi cortada pelo limite de tamanho.)',
    ...
    aiNoProviderTitle: 'Nenhum provedor de IA configurado — abra as configurações de IA para escolher.',
    aiNoProviderButton: 'Abrir as configurações de IA',
    ...
    aiMemoryBadgeTip: 'Memória do projeto: {n} entradas (a IA se lembra delas)',
    ...
    aiThinkingAria: 'Pensando',
    aiThinking: 'Pensando…',
    aiThoughtFor: 'Pensado por {n}s',
    aiStatusAnalyzing: 'Analisando seu pedido…',
    aiStatusRunning: 'Executando {tool}…',
    aiStatusContinuing: 'Continuando…',
  ...
  it: {
    aiInterruptedNote: 'Connessione interrotta: {error}',
    aiResumeNow: 'Riprendi',
    aiContinue: 'Continua',
    aiTruncatedNote: '(La risposta è stata troncata per il limite di lunghezza.)',
    ...
    aiNoProviderTitle: 'Nessun provider di IA configurato — apri le impostazioni IA per sceglierne uno.',
    aiNoProviderButton: 'Apri impostazioni IA',
    ...
    aiMemoryBadgeTip: "Memoria del progetto: {n} elementi (l’IA li ricorda)",
    ...
    aiThoughtFor: 'Pensato per {n}s',
    aiStatusAnalyzing: 'Analizzando la richiesta…',
    aiStatusRunning: 'Esecuzione di {tool}…',
    aiStatusContinuing: 'Continuazione…',
  ...
  pl: {
    aiInterruptedNote: 'Połączenie przerwane: {error}',
    aiResumeNow: 'Wznów',
    aiContinue: 'Kontynuuj',
    aiTruncatedNote: '(Odpowiedź została przycięta z powodu limitu długości.)',
    ...
    aiNoProviderTitle: 'Nie skonfigurowano dostawcy AI — otwórz ustawienia AI, aby wybrać.',
    aiNoProviderButton: 'Otwórz ustawienia AI',
    ...
    aiMemoryBadgeTip: 'Pamięć projektu: {n} wpisów (AI je zapamiętuje)',
    ...
    aiThinking: 'Myślenie…',
    aiThoughtFor: 'Myślano przez {n}s',
    aiStatusAnalyzing: 'Analizuję prośbę…',
    aiStatusRunning: 'Uruchamiam {tool}…',
    aiStatusContinuing: 'Kontynuuję…',
  ...
  nl: {
    aiInterruptedNote: 'Verbinding onderbroken: {error}',
    aiResumeNow: 'Hervatten',
    aiContinue: 'Doorgaan',
    aiTruncatedNote: '(Het antwoord is afgebroken door de lengtelimiet.)',
    ...
    aiNoProviderTitle: 'Er is nog geen AI-leverancier geconfigureerd — open de AI-instellingen om er een te kiezen.',
    aiNoProviderButton: 'AI-instellingen openen',
    ...
    aiMemoryBadgeTip: 'Projectgeheugen: {n} items (de AI onthoudt deze)',
    ...
    aiThoughtFor: 'Nagedacht gedurende {n}s',
    aiStatusAnalyzing: 'Verzoek analyseren…',
    aiStatusRunning: '{tool} uitvoeren…',
    aiStatusContinuing: 'Doorgaan…',
  ...
  ms: {
    aiInterruptedNote: 'Sambungan terganggu: {error}',
    aiResumeNow: 'Sambung semula',
    aiContinue: 'Sambung',
    aiTruncatedNote: '(Balasan terpotong kerana had panjang.)',
    ...
    aiNoProviderTitle: 'Belum ada pembekal AI dikonfigurasikan — buka tetapan AI untuk memilih.',
    aiNoProviderButton: 'Buka tetapan AI',
    ...
    aiMemoryBadgeTip: 'Memori projek: {n} entri (AI mengingatinya)',
    ...
    aiThoughtFor: 'Berfikir selama {n}s',
    aiStatusAnalyzing: 'Menganalisis permintaan…',
    aiStatusRunning: 'Menjalankan {tool}…',
    aiStatusContinuing: 'Meneruskan…',
    aiWorkedSteps: 'Selesai · {n} langkah',
  ...
  he: {
    aiInterruptedNote: 'החיבור נותק: {error}',
    aiResumeNow: 'המשך',
    aiContinue: 'המשך',
    aiTruncatedNote: '(התשובה נקטעה עקב מגבלת האורך.)',
    ...
    aiNoProviderTitle: 'לא הוגדר ספק AI — פתח את הגדרות ה-AI כדי לבחור.',
    aiNoProviderButton: 'פתח את הגדרות AI',
    ...
    aiSetUp: 'הגדרת AI',
    aiNewChat: 'שיחה חדשה',
    aiMemoryBadgeTip: 'זיכרון הפרויקט: {n} רשומות (ה-AI זוכר אותן)',
    ...
    aiThinkingAria: 'חושב',
    aiThinking: 'חושב…',
    aiThoughtFor: 'חשבתי במשך {n} שניות',
    aiStatusAnalyzing: 'מנתח את הבקשה…',
    aiStatusRunning: 'מריץ {tool}…',
    aiStatusContinuing: 'ממשיך…',
  ...
  hi: {
    aiInterruptedNote: 'कनेक्शन टूट गया: {error}',
    aiResumeNow: 'फिर से शुरू करें',
    aiContinue: 'जारी रखें',
    aiTruncatedNote: '(उत्तर लंबाई सीमा के कारण कट गया।)',
    ...
    aiNoProviderTitle: 'कोई AI प्रदाता कॉन्फ़िगर नहीं हुआ —चुनने के लिए AI सेटिंग खोलें।',
    aiNoProviderButton: 'AI सेटिंग खोलें',
    ...
    aiSetUp: 'AI सेट करें',
    aiNewChat: 'नई बातचीत',
    aiMemoryBadgeTip: 'प्रोजेक्ट मेमोरी: {n} प्रविष्टियाँ (AI इन्हें याद रखता है)',
    ...
    aiThoughtFor: '{n} सेकंड के लिए सोचा',
    aiStatusAnalyzing: 'अनुरोध का विश्लेषण किया जा रहा है…',
    aiStatusRunning: '{tool} चलाया जा रहा है…',
    aiStatusContinuing: 'जारी है…',
  ...
  'zh-TW': {
    aiInterruptedNote: '連線中斷: {error}',
    aiResumeNow: '繼續執行',
    aiContinue: '繼續',
    aiTruncatedNote: '（回覆因長度限制被截斷，可能不完整。）',
    ...
    aiNoProviderTitle: '尚未設定 AI 提供者，請在 AI 設定中選擇一個。',
    aiNoProviderButton: '開啟 AI 設置',
    ...
    aiSetUp: '設定 AI',
    aiNewChat: '新對話',
    aiMemoryBadgeTip: '{n} 條專案記憶（AI 會記住這些內容）',
    ...
    aiThinking: '思考中…',
    aiThoughtFor: '已思考 {n} 秒',
    aiStatusAnalyzing: '正在分析請求…',
    aiStatusRunning: '正在執行 {tool}…',
    aiStatusContinuing: '繼續處理中…',
