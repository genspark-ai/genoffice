...
export const de = {
  ...
  appReplace: 'Ersetzen',
  appGoTo: 'Gehe zu',
  appGroupScripts: 'Skripte',
  appScripts: 'Skripte',
  appScriptsDetail: 'Eigenen Code schreiben und ausführen',
  dlgScriptsTitle: 'Skript-Editor',
  dlgScriptsNew: 'Neu',
  dlgScriptsDelete: 'Löschen',
  dlgScriptsUntitled: 'Unbenanntes Skript',
  dlgScriptsRun: 'Ausführen',
  dlgScriptsStop: 'Stopp',
  dlgScriptsOutput: 'Ausgabe',
  dlgScriptsClose: 'Schließen',
  dlgScriptsHelp:
