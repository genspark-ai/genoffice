...
export const pt = {
  ...
  appScripts: 'Scripts',
  appScriptsDetail: 'Escreva e execute seu próprio código',
  dlgScriptsTitle: 'Editor de scripts',
  dlgScriptsNew: 'Novo',
  dlgScriptsDelete: 'Excluir',
  dlgScriptsUntitled: 'Script sem nome',
  dlgScriptsRun: 'Executar',
  dlgScriptsStop: 'Parar',
  dlgScriptsOutput: 'Saída',
  dlgScriptsClose: 'Fechar',
  dlgScriptsHelp:
