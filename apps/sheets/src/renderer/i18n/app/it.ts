...
export const it = {
  ...
  appGoTo: 'Vai a',
  appGroupScripts: 'Script',
  appScripts: 'Script',
  appScriptsDetail: 'Scrivi ed esegui il tuo codice',
  dlgScriptsTitle: 'Editor di script',
  dlgScriptsNew: 'Nuovo',
  dlgScriptsDelete: 'Elimina',
  dlgScriptsUntitled: 'Script senza nome',
  dlgScriptsRun: 'Esegui',
  dlgScriptsStop: 'Ferma',
  dlgScriptsOutput: 'Output',
  dlgScriptsClose: 'Chiudi',
  dlgScriptsHelp:
