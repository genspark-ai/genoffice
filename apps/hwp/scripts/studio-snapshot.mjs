...
function attachTableSurface(js) {
  let next = js.replace(PREPARE_TEXT_V2_MARK, PREPARE_TEXT_V3_MARK)
  next = next.replace(
    SET_FIELD_CLASS_RE,
...
export function exposePrepareTextCommand(js) {
  if (js.includes(PREPARE_TEXT_V3_MARK)) return js
  if (js.includes(PREPARE_TEXT_V2_MARK)) {
