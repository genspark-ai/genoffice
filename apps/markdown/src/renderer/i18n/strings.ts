export const strings = {
  ...
  ja: {
    ...
    insertToggle: 'トグル',
    slashNoResults: '該当なし',
    toggleSummaryPlaceholder: 'トグルのタイトル…',
    fmProperties: 'プロパティ',
    underline: '下線',
    highlight: 'ハイライト',
    codeCopy: 'コピー',
  ...
  ko: {
    ...
    toggleSummaryPlaceholder: '토글 제목…',
    fmProperties: '속성',
    underline: '밑줄',
    highlight: '형광펜',
    codeCopy: '복사',
  ...
  fr: {
    ...
    insertToggle: 'Bloc dépliant',
    slashNoResults: 'Aucun résultat',
    toggleSummaryPlaceholder: 'Titre du bloc…',
  ...
  de: {
    ...
    insertToggle: 'Aufklappblock',
    slashNoResults: 'Keine Treffer',
    toggleSummaryPlaceholder: 'Titel des Blocks…',
  ...
  es: {
    ...
    insertHr: 'Separador',
    insertCallout: 'Nota destacada',
    insertToggle: 'Bloque plegable',
    slashNoResults: 'Sin resultados',
    toggleSummaryPlaceholder: 'Título del bloque…',
  ...
  th: {
    ...
    insertHr: 'เส้นแบ่ง',
    insertCallout: 'กล่องข้อความ',
    insertToggle: 'บล็อกพับเก็บ',
    slashNoResults: 'ไม่พบรายการ',
    toggleSummaryPlaceholder: 'ชื่อบล็อก…',
  ...
  id: {
    ...
    insertHr: 'Pembatas',
    insertCallout: 'Sorotan',
    insertToggle: 'Blok lipat',
    slashNoResults: 'Tidak ada hasil',
    toggleSummaryPlaceholder: 'Judul blok…',
  ...
  ru: {
    ...
    insertToggle: 'Сворачиваемый блок',
    slashNoResults: 'Нет результатов',
    toggleSummaryPlaceholder: 'Заголовок блока…',
  ...
  ar: {
    ...
    insertHr: 'فاصل',
    insertCallout: 'تنبيه',
    insertToggle: 'كتلة قابلة للطي',
    slashNoResults: 'لا نتائج',
    toggleSummaryPlaceholder: 'عنوان الكتلة…',
    fmProperties: 'خصائص',
    underline: 'تسطير',
    highlight: 'تمييز',
    codeCopy: 'نسخ',
  ...
  pt: {
    ...
    insertHr: 'Divisor',
    insertCallout: 'Destaque',
    insertToggle: 'Bloco recolhível',
    slashNoResults: 'Sem resultados',
    toggleSummaryPlaceholder: 'Título do bloco…',
  ...
  it: {
    ...
    insertHr: 'Divisore',
    insertCallout: 'Richiamo',
    insertToggle: 'Blocco comprimibile',
    slashNoResults: 'Nessun risultato',
    toggleSummaryPlaceholder: 'Titolo del blocco…',
  ...
  pl: {
    ...
    insertHr: 'Separator',
    insertCallout: 'Wyróżnienie',
    insertToggle: 'Blok zwijany',
    slashNoResults: 'Brak wyników',
    toggleSummaryPlaceholder: 'Tytuł bloku…',
  ...
  nl: {
    ...
    insertCallout: 'Callout',
    insertToggle: 'Uitklapblok',
    slashNoResults: 'Geen resultaten',
    toggleSummaryPlaceholder: 'Bloktitel…',
  ...
  ms: {
    ...
    insertHr: 'Pemisah',
    insertCallout: 'Seruan',
    insertToggle: 'Blok lipat',
    slashNoResults: 'Tiada hasil',
    toggleSummaryPlaceholder: 'Tajuk blok…',
    fmProperties: 'Sifat',
    underline: 'Garis bawah',
    highlight: 'Sorotan',
    codeCopy: 'Salin',
  ...
  he: {
    ...
    insertHr: 'קו מפריד',
    insertCallout: 'הבלטה',
    insertToggle: 'בלוק מתקפל',
    slashNoResults: 'אין תוצאות',
    toggleSummaryPlaceholder: 'כותרת הבלוק…',
  ...
  hi: {
    ...
    insertHr: 'विभाजक',
    insertCallout: 'कॉलआउट',
    insertToggle: 'टॉगल ब्लॉक',
    slashNoResults: 'कोई परिणाम नहीं',
    toggleSummaryPlaceholder: 'ब्लॉक शीर्षक…',
    fmProperties: 'गुण',
    underline: 'रेखांकित',
    highlight: 'हाइलाइट',
    codeCopy: 'कॉपी',
